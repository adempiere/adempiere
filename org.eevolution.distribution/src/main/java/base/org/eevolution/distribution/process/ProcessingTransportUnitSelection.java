...
public class ProcessingTransportUnitSelection extends ProcessingTransportUnitSelectionAbstract {
    ...
    protected String doIt() throws Exception {
        List<org.eevolution.distribution.model.MDDTransportUnit> transportUnits = (List<org.eevolution.distribution.model.MDDTransportUnit>) getInstancesForSelection(get_TrxName());
        if (getRecord_ID() > 0 && getSelectionKeys().size() > 0 && getTableSelectionId() == org.eevolution.distribution.model.MDDTransportUnit.Table_ID) {
            if (getProcessInfo().getTable_ID() == org.eevolution.distribution.model.MDDTransportUnit.Table_ID) {
                org.eevolution.distribution.model.MDDTransportUnit transportUnitFrom = transportUnits.stream().findFirst().get();
                org.eevolution.distribution.model.MDDTransportUnit transportUnitTo = (org.eevolution.distribution.model.MDDTransportUnit) getInstance(get_TrxName());
     ...
     */
    private void UpdatingTransportUnit(List<org.eevolution.distribution.model.MDDTransportUnit> transportUnits) {
     ...
     */
    protected void CopyTransportUnit(org.eevolution.distribution.model.MDDTransportUnit transportUnitFrom, MDDTransportUnit transportUnitTo) {
