...
public abstract class GenerateMovementAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "M_Movement Generate Movement";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Movement from Distribution Order";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 53735;
