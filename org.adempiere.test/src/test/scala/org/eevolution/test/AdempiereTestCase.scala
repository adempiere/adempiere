...
import org.compiere.model.{MWarehouse, MOrg}
import org.compiere.util.{Trx, Env}
import org.eevolution.service.{AdempiereStartup, Warehouse, Organization, Context}
import org.scalatest.{Suite, BeforeAndAfterAll, BeforeAndAfterEach}

/**
  * Define a trait to create a ADempiere test
...
trait AdempiereTestCase extends AdempiereStartup with Suite with BeforeAndAfterAll {
  ...
  def Context : Context = Env.getCtx
