...
package org.eevolution.fleet.util;
...
public class FleetUtil {
     ...
     * @param isReceipt
     */
    public static void setMovementOrderLine(MMovementLine movementLine, org.eevolution.fleet.model.MDDOrderLine oLine, BigDecimal Qty, boolean isReceipt) {
