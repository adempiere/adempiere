...
-- Application Dictionary
ALTER TABLE AD_Element ADD AD_Reference_ID NUMBER(10) DEFAULT NULL 
;

-- Nov 17, 2009 3:22:12 PM CST
-- Application Dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,58589,302,0,11,276,'FieldLength',TO_DATE('2009-11-17 15:22:11','YYYY-MM-DD HH24:MI:SS'),0,'Length of the column in the database','D',10,'The Length indicates the length of a column as defined in the database.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Length',0,TO_DATE('2009-11-17 15:22:11','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Application Dictionary
ALTER TABLE AD_Element ADD AD_Reference_Value_ID NUMBER(10) DEFAULT NULL 
;

-- Nov 17, 2009 3:25:31 PM CST
-- Application Dictionary
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,58589,58076,0,203,TO_DATE('2009-11-17 15:25:29','YYYY-MM-DD HH24:MI:SS'),0,'Length of the column in the database',10,'D','The Length indicates the length of a column as defined in the database.','Y','Y','Y','N','N','N','N','N','Length',TO_DATE('2009-11-17 15:25:29','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Application Dictionary
UPDATE AD_Field SET DisplayLogic='@AD_Reference_ID@=17 | @AD_Reference_ID@=18 | @AD_Reference_ID@=30 | @AD_Reference_ID@=28',Updated=TO_DATE('2009-11-17 15:30:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=58078
;
...
-- Application Dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-11-17 15:32:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=58076
;

-- Nov 17, 2009 3:33:06 PM CST
-- Application Dictionary
UPDATE AD_Element SET AD_Reference_ID=18,Updated=TO_DATE('2009-11-17 15:33:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=2491
;
