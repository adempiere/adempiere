...
-- Cost Engine
UPDATE AD_Column SET FieldLength=22,Updated=TO_TIMESTAMP('2010-11-16 20:41:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=59913
;

-- Nov 16, 2010 8:45:21 PM CST
-- Cost Engine
UPDATE AD_Tab SET OrderByClause='DateAcct , M_CostDetail_ID',Updated=TO_TIMESTAMP('2010-11-16 20:45:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=748
;
...
-- Cost Engine
UPDATE AD_Column SET DefaultValue='N',Updated=TO_TIMESTAMP('2010-11-17 01:54:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=59917
;
...
-- Cost Engine
INSERT INTO t_alter_column values('m_costelement','IsDefault','CHAR(1)',null,'N')
;
