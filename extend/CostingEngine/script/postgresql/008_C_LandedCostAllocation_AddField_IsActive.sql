...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE C_LandedCostAllocation ADD COLUMN IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
