...
/** Generated Process for (Export Catalog to External Cache)
...
public abstract class ExportCatalogAbstract extends SvrProcess {
	...
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Export Catalog to External Cache";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54448;
