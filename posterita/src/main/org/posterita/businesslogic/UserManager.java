...
public class UserManager
{
    ...
    public static MUser createUser(Properties ctx,String userName,String userSurname,boolean isSalesRep,String address,String postalAddress,String city,String password,String email,boolean isActive,String phone,int regionId,int roleId,int countryId, String userPIN, BigDecimal userDiscount,String docBasisType,BigDecimal amtMultiplier,String frequency,BigDecimal subtractAmt,boolean isFullAccess,String trxName) throws DuplicateUserPinException,OperationException
    {
        ...
        MBPartner bpartner = BPartnerManager.createBPartner(ctx, parentOrg.getLinkedC_BPartner_ID(trxName), userName,userSurname,false,false,true,isSalesRep,address, postalAddress,city,phone,countryId, trxName);
    ...
    public static void deleteUser(Properties ctx, int userId) throws OperationException
    {
        ...
        UDIMUser mUser =  new UDIMUser(user);
    ...
    public static MUser editUser(Properties ctx, int userId, int roleId, String password,String email, String phoneNo, String address1, String postalAddress1, String city, boolean isSalesRep, boolean isActive,String userPin,BigDecimal userDiscount,String docBasisType,BigDecimal amtMultiplier,String frequency,BigDecimal subtractAmt,boolean isFullAccess, String trxName) throws DuplicateUserPinException,OperationException
    {
        ...
        try
        {
            ...
            UDIMBPartner mBPartner = new UDIMBPartner(partner);
            mBPartner.save();
    ...
    public static MUser getOrCreateUser(Properties ctx,String userName,boolean isSalesRep,String address,String postalAddress,String city,String password,String email,boolean isActive,String phone,int regionId,int roleId,String userPin,String commDocbaseType,BigDecimal commRate,String frequency, BigDecimal subtractAmt,boolean isFullAccess,String trxName) throws OperationException
    {
        ...
        if(userId.length > 0)
            ...
            user = createUser(ctx, userName,null, isSalesRep, address, postalAddress, city, password, email, isActive, phone, regionId, roleId,countryId,userPin,null,commDocbaseType,commRate,frequency,subtractAmt,isFullAccess,trxName);
        
        return user;
    }
    
    public static MUser getUdiAdmin(Properties ctx) throws SystemException
    {
        int [] userId = MUser.getAllIDs(MUser.Table_Name," AD_CLIENT_ID = "+Env.getAD_Client_ID(ctx) + " and name = 'UdiAdmin'",null);
        
        if(userId.length == 0)
        {
            throw new SystemException("Unable to get UdiAdmin");
        }
        
        MUser user = new MUser(ctx, userId[0], null);
