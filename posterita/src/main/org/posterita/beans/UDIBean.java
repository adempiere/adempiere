...
public class UDIBean
{
    ...
    protected Integer openingBalanceQty;
    protected Integer qtyOfGoodsSold;
    protected Integer qtyOfGoodsReceived;
    protected Integer qtyOfGoodsReturned;
    protected Integer closeingBalanceQty;
    protected Integer qtyReturnedByCustomer;
    ...
    protected Integer qtyInventoryIn;
    protected Integer qtyInventoryOut;
