...
<bean:define id="title"><pos:element columnName="Attribute" textOnly="true"/></bean:define>
...
<%@ include file="/jsp/include/errors.jsp" %>
	...
	<div>
		<label><pos:element columnName="choose.attribute"/></label>
		...
		<html:submit><pos:element textOnly="true" columnName="list"/></html:submit>
	</div>
	<div class="space"></div>
	<div class="space"></div>	
		...
		%>
			<tr>
				...
				<td align="center" class="<%= style%>" width="50px;">
					...
					%>
					<a href="<%= editLink%><bean:write name='AttributeValuesForm' property='attributeId'/>"><pos:element columnName="edit"/></a>
				</td>
