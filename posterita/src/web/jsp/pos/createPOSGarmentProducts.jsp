...
<bean:define id="title"><pos:element textOnly="true" columnName="create.garment"/></bean:define>
...
<table class="view" width="100%">
	<tr>
		...
		<table class="view" width="100%">
			<tr>
				<td><label><pos:element columnName="description"/>:</label><mandatory>*</mandatory></td>
				<td>
					<html:text property="description" style="width:400px"  styleClass="text"/>
				</td>
			</tr>
			<tr>
				<td><label><pos:element columnName="brand"/>:</label><mandatory>*</mandatory></td>
				<td>
			...
			<tr>
				<td><label><pos:element columnName="model"/>:</label><mandatory>*</mandatory></td>
				<td>
			...
			<tr>
				<td><label><pos:element columnName="design"/>:</label><mandatory>*</mandatory></td>
				<td>
			...
			<tr>		
				<td><label><pos:element columnName="colour"/></label><mandatory>*</mandatory></td>
				<td>
			...
			<tr>		
				<td><label><pos:element columnName="C_RevenueRecognition_ID"/></label><mandatory>*</mandatory></td>
				<td>									
			...
			<tr>
				<td>
  					<label><pos:element columnName="C_TaxCategory_ID"/></label>
				</td>
			   	<td>
				...
				<td colspan="2">
					...
					<table>
						<tr>		
							...
							<td align="right">
								<label><pos:element columnName="incl.vat"/></label>
							</td>
		...
		<td>				
			<table class="view">
				<tr>
					<td colspan="2">
						<fieldset>
							<legend><pos:element columnName="size"/><mandatory>*</mandatory> <pos:element columnName="at.least.one"/></legend>
