...
<bean:define id="title"><pos:element columnName="commission.details" textOnly="true"/></bean:define>
		...
		<td>		
			<%@ include file="/jsp/include/errors.jsp" %>	 
				<table class="display scrollpane sortable" id="1111" border="1">
					...
					<tr>
						<th><pos:element columnName="Reference"/></th>
						<th width="80px"><pos:element columnName="Info"/></th>
						<th><pos:element columnName="Price"/></th>
