...
<table align="left" cellpadding="5">
	<tr>
		<td>
			<fieldset>
				<legend><pos:element columnName="customer"/></legend>
				<table>
				<tr>			
				...
				<tr>
					<td><label><pos:element columnName="Name2"/></label><mandatory>*</mandatory></td>
				...
				<table>
					<tr>			
					<td><label><pos:element columnName="SOCreditStatus"/></label><mandatory>*</mandatory></td>
					<td>
					...
					<tr>			
						<td><label><pos:element columnName="SO_CreditLimit"/></label></td>
				...
				<table>
					<tr>
						...
						<td><label><pos:element columnName="Address1"/></label><mandatory>*</mandatory></td>
				...
				<table>
					...
					<tr>			
						<td><label><pos:element columnName="mobile"/>:</label></td>
