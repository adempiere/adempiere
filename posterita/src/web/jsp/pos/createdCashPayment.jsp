...
<bean:define id="title"><pos:element textOnly="true" columnName="cash.receipt"/></bean:define>
	...
	<table width="100%" border="0" cellpadding="5" cellspacing="0" class="orderheader">
		...
		<tr>
			<td>
				...
				<br>
  				...
  				<pos:element columnName="Ref_Payment_ID"/>: <c:out value='${cashLine._ID}'/><br>
		...
		<tr>
  			...
  			<div class="space"></div>
				<table class="cart">
			  		<tr>
					   	<th class="contentname" align="left"><pos:element columnName="PayDate"/>:</th>
					   	<th class="contentname" align="left"><pos:element columnName="PayAmt"/>:</th>
			  		</tr>
