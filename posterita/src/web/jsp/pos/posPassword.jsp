...
<title><pos:element textOnly="true" columnName="posPassowrd.welcome"/></title>
...
<tr><td  align="center" valign="middle">
	<table class="login" align="center" cellpadding="0" cellspacing="0">
		 		...
		 		<td height="330px" bgcolor="#CCCCCC" valign="middle" align="center">
					<table class="loginbox" width="300" align="center" cellpadding="5"
						...
						<tr>
							...
							<pos:element columnName="login.password.passwordSent"/></td>
						</tr>
						<tr class="white">
							<td align="center"><html:link href="POSLogin.do"
								...
								<pos:element columnName="login.password.backToLogin"/>
							</html:link><br>
							</td>
						</tr>
					</table>								
		...
		<tr>	
			<td>
				<div class="copyright"><pos:element columnName="login.home.all.contents"/>  &copy;2006 Tamak ICT</div>
			</td>
		</tr>		
	</table>
</body>
