...
<bean:define id="title"><pos:element textOnly="true" columnName="smenu.price.check"/></bean:define>
...
<tr>
	<td colspan="2" align="right">
		<html:submit accesskey="i" styleClass="blank smallbutton"><pos:element columnName="Check" textOnly="true"/></html:submit>
	</td>
</tr>
