...
<bean:define id="title"><pos:element columnName="stock.movement" textOnly="true"/></bean:define>
...
<tr>		
	...
	<th><pos:element columnName="opening.balance"/></th>			
	<th><pos:element columnName="qty.received"/></th>				
	<th><pos:element columnName="qty.sold"/></th>				
	<th><pos:element columnName="qty.returned.to.supplier"/></th>
	<th><pos:element columnName="qty.returned.by.customer"/></th>				
	<th><pos:element columnName="closing.balance"/></th>
</tr>		
