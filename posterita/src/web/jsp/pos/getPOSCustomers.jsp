...
<%@ include file="/jsp/include/tabTop.jsp" %><pos:element columnName="pos.order"/><%@ include file="/jsp/include/tabBottom.jsp" %>	   
			...
			<tr>
				<td align="right">
					<html:button property="btn" styleClass="bigbtn" onclick="createCustomer()" accesskey="n">
						<pos:element columnName="new.customer"/>
					</html:button>		
				</td>
			</tr>	
		</table>
...
<tr>     
	<td>
		<html:button property="btn" styleClass="cntbtn" onclick="getPaymentDetails()" accesskey="c">
	   	 <pos:element columnName="continue"/>
	   	</html:button>				 	
   	</td>	
</tr> 
<tr>
...
<tr>					  
	<td align="center">
		<table border="0" cellpadding="10">
			<tr>
				<td>
					<span class="shortcutkey"><pos:element columnName="new.customer"/> - Alt-N</span>
				</td>
				<td>
					<span class="shortcutkey"><pos:element columnName="search"/> - Alt-S</span>
				</td>
				<td>
					<span class="shortcutkey"><pos:element columnName="continue"/> - Alt-C</span>
				</td>				
