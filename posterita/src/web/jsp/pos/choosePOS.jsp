...
<html:hidden property="action" value="<%=POSOrderAction.CHOOSE_POS%>"/>
			...
			<td height="330px" bgcolor="#CCCCCC" valign="middle" align="center">
				...
				<tr>
					<td colspan="2" align="center">
						<label><pos:element columnName="choose.your.till"/></label>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
				...
				<tr>
					...
					<td>
						<html:select property="posId" onchange="Submit()">
							<html:options collection="<%= Constants.POSIDS %>" property="posId" labelProperty="posName"/>																																	
						</html:select>
					</td>
				</tr>				
				<tr>
