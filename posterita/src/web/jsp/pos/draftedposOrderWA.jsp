...
<bean:define id="title"><pos:element textOnly="true" columnName="smenu.cash.sales"/></bean:define>
...
<%@ include file="/jsp/pos/orderHeader.jsp" %> 
 	...
 	<tr>
		...
		<table border="0" cellpadding="5" cellspacing="0" align="center">			
			<tr>
				<td>
					<label><b><pos:element columnName="AmountTendered"/>:</b></label>
				</td>
				<td>
					<html:text property="amountGiven" styleClass="text" onkeyup="updateAmountToBeReturned(this)" accesskey="g"/>
				</td>			
				<td>
					<LABEL><b><pos:element columnName="AmountRefunded"/>:</b></LABEL>
				</td>
				<td>
			...
			<div align="center">
				<table border="0" cellpadding="10">
					<tr>
						...
						<td>
							<label><pos:element columnName="AmountGiven"/> -</label><label class="red">Alt-G</label>
						</td>
						<td>
