...
<bean:define id="title"><pos:element textOnly="true" columnName="sales.reports"/></bean:define>
...
<table class="content" border="1">
	<tr>
		<td valign="top">
			<pos:element columnName="account.type"/>:<br>
			<html:select property="accountId" styleClass="text">
				<html:option value="41000"><pos:element columnName="sales"/></html:option>	
			</html:select>
		</td>
		...
		<td valign="top" rowspan="2" style="height:120px;width:500px" align="center">				
			<div id="fixedDatePanel">
				...
				<label><pos:element columnName="select.range"/>:</label>
					...
					<tr>
						<td>
							<table align="center">
								<tr>
									<td width="40px">
										<label><pos:element columnName="from"/>:</label>
									</td>
					...
					<tr>
						<td>
							<table align="center">
								<tr>
									<td width="40px">
										<label><pos:element columnName="to"/>:</label>
									</td>
	...
	<tr>
		<td colspan="2">
			<pos:element columnName="IsGroupBy"/>:<br>
	...
	<tr>
		<td colspan="3">
			...
			<div style="border: solid 1px black;display:inline;">
				...
				<br>
				<p align="right">
					<a href="<%=csvFile%>"><pos:element columnName="save.as.csv"/></a>
