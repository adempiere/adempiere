...
<div id="barcodeError" class="errormsg"><pos:element columnName="barcode.already.exists"/></div>	
<div id="productError" class="errormsg"><pos:element columnName="product.already.exists"/></div>	
</div>					
<table align="left" cellpadding="5" width="100%" border="0">
	...
	<tr>
		<td>
			<fieldset>
				<legend><pos:element columnName="TextDetails"/> </legend>
				<table>
				<tr>
					<td>
				...
				<tr>		
					<td>
						<label><pos:element columnName="attach.image"/></label>
					</td>
						<td colspan="3">
