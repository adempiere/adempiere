...
<div align="right">
	<logic:present name="<%= Constants.PRODUCT_CART %>">		
		<span id="productCount">
			...
			</strong><pos:element columnName="cart.items"/>
		</span>		
	</logic:present>
	<logic:notPresent name="<%= Constants.PRODUCT_CART %>">
		<span id="productCount">
			<pos:element columnName="cart.empty"/>
		</span>
	</logic:notPresent>
	<span id="cartLinkPanel">
		<html:link action="/ViewAllPOSProductsForUpdateAction.do?action=viewCart"><pos:element columnName="view"/></html:link>			
		<a href="javascript:void(0);" id="clearCart"><pos:element columnName="clear"/></a>
	</span>
</div>
<logic:empty name="<%=Constants.POS_PRODUCTS_FOR_UPDATE%>">
	<div><pos:element columnName="search.product.notfound"/><b><bean:write name="ViewProductForm" property="productName"/></b></div>
	<div class="space"></div>
</logic:empty>
	...
	<table class="display" border="1" width="900px">
		<tr>
			<th><pos:element columnName="Name"/></th>
	   	    <th nowrap="nowrap"><pos:element columnName="purchase.price"/></th>  
	   	    <th nowrap="nowrap"><pos:element columnName="sales.price"/></th>   
	   	    <th nowrap="nowrap">&nbsp;</th>
	 	</tr>		
