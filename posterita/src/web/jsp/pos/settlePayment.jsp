...
<bean:define id="title"><pos:element columnName="smenu.settle.payment.credit.sales" textOnly="true"/></bean:define>
...
<td valign="top" width="400px">
	<fieldset>
	<legend><pos:element columnName="customer.info" textOnly="true"/></legend>
	<div>
		<div>
			<label><pos:element columnName="customer.id" textOnly="true"/></label>
		</div>
		<html:text property="bpartnerId" styleClass="text" accesskey="i"/> 
		<div>
			<label><pos:element columnName="search.customer" textOnly="true"/></label>
		</div>
...
<table>
	<tr>
		<pos:element columnName="settle.payment.message"/>
	</tr>
	<tr>
		<td>
			&nbsp;
...
<html:hidden property="action" value="<%=CreditOrderAction.MATCH_INVOICE%>"/>
	...
	<tr>
			<th align="left">
				<b><pos:element columnName="open.invoices" textOnly="true"/></b>
			</th>
		</tr>
		<tr>
			<td>
				...
				<tr>
						...
						<th>
							<pos:element columnName="invoice.no" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="order.no" textOnly="true"/>
						</th>
					
						<th>
							<pos:element columnName="Date1" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="PaymentTerm" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="DaysDue" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="DueDate" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="C_Currency_ID" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="discount.amt" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="GrandTotal" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="PaidAmt" textOnly="true"/>
						</th>
						
						<th>
							<pos:element columnName="OpenAmt" textOnly="true"/>
						</th>	
						<th>
							&nbsp;
						</th>						
	...
	<tr>
			<th align="left">
				<b><pos:element columnName="unallocated.payments" textOnly="true"/></b>
			</th>
	</tr>
		<tr>
			<td>
				...
				<tr>
						...
						<th>
							<pos:element columnName="C_Payment_Id" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="DateTrx" textOnly="true"/>
						</th>
					
						<th>
							<pos:element columnName="TenderType" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="payAmt" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="OverUnderPayment" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="allocatedAmt" textOnly="true"/>
						</th>
						<th>
							<pos:element columnName="availableAmt" textOnly="true"/>
						</th>
						<th>
							&nbsp;
						</th>
		...
		<tr>
			<th align="left">
				<b><pos:element columnName="aging" textOnly="true"/></b>
			</th>
		</tr>
			<tr>
				<td>
					<table border="1" class="display">	
									...
									<th>
										<pos:element columnName="InvoicedAmt" textOnly="true"/>
									</th>
									<th>
										<pos:element columnName="OpenAmt" textOnly="true"/>
									</th>
									...
									<th>
										<pos:element columnName="PastDue91_Plus" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDue61_90" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDue31_60" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDue1_30" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDue8_30" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDue1_7" textOnly="true"/>
									</th>
									
									<th>
										<pos:element columnName="PastDueAmt" textOnly="true"/>
									</th>
			...
			<tr>
				<td>
					<table border="1" class="display">	
									...
									<th>
										<pos:element columnName="DueAmt" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due0" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due1_7" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due8_30" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due0_30" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due31_60" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due61_90" textOnly="true"/>
									</th>
									
									
									<th>
										<pos:element columnName="Due91_PLUS" textOnly="true"/>
									</th>
