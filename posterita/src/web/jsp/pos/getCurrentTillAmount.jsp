...
<bean:define id="title"><pos:element textOnly="true" columnName="smenu.current.money.in.terminal"/></bean:define>
...
<div style="width:400px">		    			
    ...
    <bean:define id="currSymbole" name="<%= Constants.CURRENCY_SYMBOLE %>"/>
   	<tr>  	    
		<th nowrap="nowrap">	
			<pos:element columnName="pos.name"/>
		</th>   			          
        <th>
	...
	<tr>
    	<td nowrap="nowrap">	
       		<pos:element columnName="opening.balance"/>
    	</td>
   		<td>
  	...
  	<tr>
    	<td nowrap="nowrap">	
       		<pos:element columnName="net.transaction"/>
    	</td>
   		<td>
	...
	<tr>
    	<td nowrap="nowrap">	
       		<pos:element columnName="cash.total"/>
    	</td>
   		<td>
	...
	<tr>
		<td nowrap="nowrap">
			<pos:element columnName="card.total"/>
		</td>
		<td>				
	...
	<tr>
		<td nowrap="nowrap">	
			<pos:element columnName="cheque.total"/>
		</td>
		<td>								
