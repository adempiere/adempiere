...
<bean:define id="title"><pos:element textOnly="true" columnName="add.black.listed.cheque"/></bean:define>
...
<table align="left" cellpadding="5">
	<tr>
		<td>
			...
			<tr>
				<td>
					<label>	<pos:element columnName="BankName"/>:</label><mandatory>*</mandatory>
				</td>
			...
			<tr>
				<td>
					<label>	<pos:element columnName="CheckNo"/>:</label><mandatory>*</mandatory>
				</td>
