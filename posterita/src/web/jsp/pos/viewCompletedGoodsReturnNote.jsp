...
<bean:define id="title"><pos:element columnName="goods.returned.note" textOnly="true"/></bean:define>
...
<table class="cart">
<tr>	        
	<th align="left" colspan="2"><pos:element columnName="Name"/></th>
	...
	<th align="right"><pos:element columnName="total"/>Total</th>			
</tr>
