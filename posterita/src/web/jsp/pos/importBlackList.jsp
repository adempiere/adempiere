...
<bean:define id="title"><pos:element textOnly="true" columnName="import.black.listed"/></bean:define>
...
<tr>
	...
	<html:submit styleClass="cntbtn">
		<pos:element columnName="import.list"/>
	</html:submit>
	</td>
</tr>	
</table>	
...
<pos:element columnName="import.list"/>
<pos:element columnName="import.blacklisted.message1"/>
</font>
</div>
<br>
<table class="display" border="1"> 
  <tr>
    ...
    <th><pos:element columnName="cheque.no"/></th>
