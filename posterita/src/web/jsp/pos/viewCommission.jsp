...
<bean:define id="title"><pos:element columnName="C_Commission_ID" textOnly="true"/></bean:define>
			...
			<html:hidden property="action" value="<%=CommissionAction.VIEW_COMMISSION %>"/>					
				...
				<table class="display scrollpane sortable" id="1111" border="1">
					<tr>
						...
						<th><pos:element columnName="cal.period.curr"/></th>
						<th><pos:element columnName="TotalAmt"/></th>
						<th><pos:element columnName="AmtSubtract"/></th>
						<th><pos:element columnName="CommissionAmt"/></th>
						<th><pos:element columnName="Qty"/></th>
						<th><pos:element columnName="FrequencyType"/></th>
						<th><pos:element columnName="doc.basis.type"/></th>
						<th><pos:element columnName="Rate"/>%</th>
					</tr>
...
<div align="right">
	...
	<a href="<%=reportURL%>"><pos:element columnName="download.csv"/></a>	
</div>					
