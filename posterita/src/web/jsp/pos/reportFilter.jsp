	...
	<tr>		
		<td>
			<table align="left">
				<tr>
					<td>
						<pos:element columnName="report.filter.settings"/>
					</td>					
				</tr>
				<tr>
					<td>
						<fieldset>
						<legend><pos:element columnName="filter.type"/>:</legend>
						<select onchange="setFilter(this)">
							<option value="fixed" selected><pos:element columnName="fixed"/></option>
							<option value="custom"><pos:element columnName="custom"/></option>
						</select>
						</fieldset>
					</td>					
				</tr>
				<tr>
					<td>
						<pos:element columnName="date.range"/>:
						<div id="fixedDatePanel">
						<fieldset>
						<legend><pos:element columnName="fixed"/></legend>
						<select>
							<option value="today" selected><pos:element columnName="today"/></option>
							<option value="today"><pos:element columnName="current.week"/></option>
							<option value="today"><pos:element columnName="last.2.weeks"/></option>
							<option value="today"><pos:element columnName="last.3.weeks"/></option>
							<option value="today"><pos:element columnName="current.month"/></option>
							<option value="today"><pos:element columnName="last.3.months"/></option>
							<option value="today"><pos:element columnName="last.6.month"/></option>
							<option value="today"><pos:element columnName="current.year"/></option>
						</select>
						</fieldset>
						</div>
