...
<bean:define id="title"><pos:element columnName="view.role" textOnly="true"/></bean:define>
<%@ include file="/jsp/include/posHeader.jsp" %>
									
	<table class="display">
	<tr>
		<td><strong><pos:element columnName="Name"/> :</strong><bean:write name="<%= Constants.ROLE %>" property="name"/></td>
	</tr>
	<tr>
		<td><hr></td>					
	</tr>
	<tr>
		<td><strong><pos:element columnName="menus"/></strong></td>					
	</tr>
	<tr>
    	<td>
