...
<bean:define id="title"><pos:element columnName="all.products" textOnly="true"/></bean:define>
...
<div align="right">
	...
	<span id="cartLinkPanel">
		<html:link action="/ViewPOSProductCartAction.do?action=viewCart" styleClass="button"><pos:element columnName="view" textOnly="true"/></html:link>			
		<a href="javascript:void(0);" id="clearCart" class="button"><pos:element columnName="clear" textOnly="true"/></a>
	</span>
	<span>
		<html:link action="/SearchPOSProductsAction.do?action=addAllProducts" styleClass="button"><pos:element columnName="select.all" textOnly="true"/></html:link>
	</span>
</div>
