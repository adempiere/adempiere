...
<bean:define id="title"><pos:element textOnly="true" columnName="CreatePayment"/></bean:define>
		...
		<logic:present name="<%=Constants.CREDIT_INVOICE_INFO%>">
			<tr>
				<td>
					...
					<tr>
						<td>
							<label><pos:element columnName="C_Invoice_ID"/>:</label>
						</td>
						<td>						
					...
					<tr>
						<td>
							<label><pos:element columnName="InvoicedAmt"/>:</label>
						</td>
						<td>						
					...
					<tr>
						<td>
							<label><pos:element columnName="OpenAmt"/>:</label>
						</td>
						<td>
					...
					<tr>
						<td>
							<label><pos:element columnName="PaidAmt"/>:</label>	
						</td>
						<td>
					...
					<tr>
						<td>
							<label><pos:element columnName="PayAmt"/>:</label>		
						</td>
						<td>
						...
						<td>
							<label><pos:element columnName="OverUnderAmt"/>:</label>		
						</td>
						<td>
					...
					<tr>
						<td>
							<label><pos:element columnName="DiscountAmt"/>:</label>		
						</td>
						<td>
						...
						<td>
							<label><pos:element columnName="WriteOffAmt"/>:</label>		
						</td>
						<td>
										...
										<table border="0" cellpadding="5">
											...
											<tr>
												...
												<table>
													<tbody>
													<tr>
														<td><label><pos:element columnName="TenderType"/>:</label></td>
													...
													<tbody id="cardPanel">
													<tr>
														<td><label><pos:element columnName="CreditCardNumber"/>:</label></td>
													...
													<tr>
														<td><label><pos:element columnName="CheckNo"/>:</label></td>
