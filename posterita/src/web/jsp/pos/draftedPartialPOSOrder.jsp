...
<bean:define id="title"><pos:element textOnly="true" columnName="smenu.prepare.order"/></bean:define>
 ...
 <%--
 	<tr>
		...
		<table border="0" cellpadding="5" cellspacing="0">			
			<tr>
				<td>
					<label><pos:element columnName="AmountTendered"/>:</label>
				</td>
				<td>
					<html:text property="amountGiven" styleClass="text" onchange="loadFieldValues(this)" accesskey="g"/>
				</td>			
				<td>
					<LABEL><pos:element columnName="AmountRefunded"/>:</LABEL>
				</td>
				<td>
...
--%>
	...
	<tr>
		...
		<div align="center">
			...
			<tr>
				<td>
					<label><pos:element columnName="delete.selected"/> -</label><label class="red">Alt-D</label>
				</td>
				<td>
