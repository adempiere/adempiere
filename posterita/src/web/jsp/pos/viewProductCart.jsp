...
<bean:define id="title"><pos:element columnName="view.product.cart" textOnly="true"/></bean:define>
...
<logic:empty name="<%=Constants.PRODUCT_DETAILS%>">
	<div><pos:element columnName="cart.empty"/></div>	
	<div class="space"></div>
	<div>
		<input type="button" class="newbutton" onclick="get('SearchPOSProducts.do')" value="<pos:element columnName='cart.addmore' textOnly='true'/>">
	</div>
</logic:empty>
...
<div align="right">
	...
	<input type="button" class="newbutton" onclick="get('ViewAllPOSProduct.do')" value="<pos:element columnName='cart.addmore' textOnly='true'/>">	
</div>
<div class="space"></div>
<div class="scrollpane">
<table class="display" border="1" width="900px">
	<tr>
		<th><pos:element columnName="product.id"/></th>
		<th><pos:element columnName="Name"/></th>
		<th><pos:element columnName="Barcode"/></th> 
		<th><pos:element columnName="Qty"/></th> 
   	    <th>&nbsp;</th>
 	</tr>
 	<%
...
<div class="space"></div>
<div align="right">
	<input type="button" onclick="get('CreateCSVFileAction.do?action=createCSVFile')" class="newbutton" value="<pos:element columnName='download.csv' textOnly='true'/>">
	
	<input type="button" onclick="get('ViewPOSProductCartAction.do?action=printBarcode')" class="newbutton" value="<pos:element columnName='print.barcode' textOnly='true'/>">
	<input type="button" onclick="get('ViewProductForUpdateAction.do?action=initUpdateBulkProductDetails')" class="newbutton" value="<pos:element columnName='edit.product' textOnly='true'/>">
</div>
