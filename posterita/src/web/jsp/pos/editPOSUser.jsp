...
<bean:define id="title"><pos:element textOnly="true" columnName="edit.user"/></bean:define>
					...
					<table align="left" cellpadding="5" width="100%">
							<tr>
								<td width="50%" height="100%">
									...
									<tr>			
										<td colspan="2"><label><pos:element columnName="Name"/></label><mandatory>*</mandatory>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr>			
										<td><label><pos:element columnName="Password"/></label><mandatory>*</mandatory></td>
										<td align="right">
									...
									<table>
										<tr>
											...
											<td>
												<html:checkbox property="isFullAccess" value="true" styleClass="text"/>
											</td>
										</tr>
