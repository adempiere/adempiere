...
<bean:define id="title"><pos:element textOnly="true" columnName="M_PriceList_ID"/></bean:define>
...
<%@ include file="/jsp/include/errors.jsp" %> 
		...
		<table class="main">
			<tr>
				<td align="right">
					<html:submit><pos:element columnName="edit.price"/></html:submit>
				</td>
			</tr>
		</table>
		</html:form>
