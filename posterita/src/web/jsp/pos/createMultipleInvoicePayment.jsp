...
<bean:define id="title"><pos:element textOnly="true" columnName="create.payment"/></bean:define>
...
<table border="0" class="display">
	<tr>		
		<td>
			<fieldset>
			<label><pos:element columnName="Amount"/></label>
	...
	<tr>		
			...
			<th>
				<label><pos:element columnName="invoice.no"/></label>
			</th>
			<th>
				<label><pos:element columnName="DaysDue" textOnly="true"/></label>
			</th>
			
			<th>
				<label><pos:element columnName="DueDate" textOnly="true"/></label>
			</th>
			<th>
				<label><pos:element columnName="GrandTotal"/></label>
			</th>
			<th>				
			...
			<th align="right">				
				<label><pos:element columnName="allocate.Amt"/></label>
			</th>	
