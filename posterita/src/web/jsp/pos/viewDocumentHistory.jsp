...
<bean:define id="title"><pos:element textOnly="true" columnName="smenu.document.history"/></bean:define>
		   	...
		   	<tr>
		   		<td>
		   			<table class="display sortable" id="1111" border="1"> 		  		
						<tr>
							<th class="tableHeader" nowrap><pos:element columnName="ordered.by"/></th>
							<th class="tableHeader date" nowrap><pos:element columnName="date.ordered"/></th>						
							<th class="tableHeader" nowrap><pos:element columnName="order.no"/></th>
							<th class="tableHeader"><pos:element columnName="payment.num"/></th>
							<th class="tableHeader"><pos:element columnName="invoice.no"/></th>
							<th class="tableHeader"><pos:element columnName="shipment.no"/></th>
						</tr>
