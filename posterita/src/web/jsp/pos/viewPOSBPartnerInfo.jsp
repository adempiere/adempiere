...
<bean:define id="title"><pos:element columnName="smenu.bpartner.sales.details" textOnly="true"/></bean:define>
...
<logic:empty name="<%=Constants.BUSINESSPARTNER%>">
	<div><pos:element columnName="search.bpartner.notfound"/> : <b><bean:write name="BPartnerInfoForm" property="partnerName"/></b></div>
	<div class="space"></div>
</logic:empty>
</logic:present>
...
<table  border="0">
	<tr>
	<td>
		<label><pos:element columnName="search"/></label>
		<html:text property="partnerName" styleClass="text"/>
		<html:submit styleClass="search smallbutton">&nbsp;</html:submit>
	</td>
	<td align="right">
		<label><pos:element columnName="select.bpartner.type"/>:</label>
		<html:select property="isCustomer" onchange="submit()">
			<html:option value="true"><pos:element columnName="IsCustomer"/></html:option>	
			<html:option value="false"><pos:element columnName="IsVendor"/></html:option>
		</html:select>
	</td>	
	</tr>	
</table>
...
<table class="display sortable" border="1" id="1111">
	<tr>
		...
		<th><pos:element columnName="Address1"/></th>
		<th><pos:element columnName="Address2"/></th>
		<th><pos:element columnName="City"/></th>
		<th><pos:element columnName="Phone"/></th>
		<th><pos:element columnName="Phone2"/></th>
