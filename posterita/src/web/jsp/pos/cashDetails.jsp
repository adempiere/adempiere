...
<bean:define id="title"><pos:element textOnly="true" columnName="cash.book.history"/></bean:define>
	...
	<tr>
		...
		%>		
			<table class="display" border="1">
				<tr>
					<th><pos:element columnName="C_Cash_ID"/></th>
					<th><pos:element columnName="DocStatus"/></th>
					<th><pos:element columnName="Created"/></th>
					<th><pos:element columnName="Updated"/></th>
					<th class="numeric"><pos:element columnName="BeginningBalance" /></th>
					<th class="numeric"><pos:element columnName="ending.balance" /></th>
				</tr>					
