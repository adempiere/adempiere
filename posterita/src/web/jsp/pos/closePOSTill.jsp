	...
	<tr>
		<td valign="top">
			...
			<table>
				...
				<tr>
					<td><pos:element columnName="10_cents"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="0.10"></td>
				</tr>
				<tr>
					<td><pos:element columnName="25_cents"/></td>
		...
		<td valign="top">
			...
			<table>
				<tr>
					<td><pos:element columnName="1_dollar"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="1.00"></td>
				</tr>
				<tr>
					<td><pos:element columnName="5_dollars"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="5.00"></td>
				</tr>
				<tr>
					<td><pos:element columnName="10_dollars"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="10.00"></td>
				</tr>
				<tr>
					<td><pos:element columnName="20_dollars"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="20.00"></td>
				</tr>
				<tr>
					<td><pos:element columnName="50_dollars"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="50.00"></td>
				</tr>
				<tr>
					<td><pos:element columnName="100_dollars"/></td>
					<td><input name="denomination" type="text" class="medium text" factor="100.00"></td>
				</tr>					
			</table>
		</fieldset>
...
<html:form action="/ClosePOSTillAction" focus="transferAmount">
	<html:hidden property="action" value="<%=CashBookAction.CLOSE_TILL%>" />	
		<table border="0" align="left" >
		  ...
		  <tr>
		  		<td class="<%=styleClass%>">
		  			<label><pos:element  columnName="cash.amount"/>:</label>			    	
			    </td>
		 ...
		 <tr>	
		 		 <td class="<%=styleClass%>" colspan="1">
			    	<label><pos:element  columnName="card.amount"/>:</label>
			    </td>
		...
		<tr>	
				<td class="<%=styleClass%>">
			    	<label><pos:element  columnName="cheque.amount"/>:</label>
			    </td>
		...
		<tr>
			<td class="<%=styleClass%>">
				<label><pos:element  columnName="BeginningBalance"/>:</label>
			</td>
				
			<td class="<%=styleClass%>">
		    	<html:text name="<%=Constants.CURRENT_TILL_AMOUNT_POS%>" property="beginingBalance" styleClass="text"/>
		    	<img src="images/pos/helpIcon2.gif" name="help" tooltip="<pos:element textOnly="true" columnName="float.amt.change"/>">
		    </td>
		</tr>
		<tr>
			<td colspan="2">
		...
		<tr>
			<td colspan="2">
				<label>
					<pos:element  columnName="cash.to.transfer"/>: <strong><span id="cashToTransfer">0</span></strong>
				</label>
			</td>
		</tr>
