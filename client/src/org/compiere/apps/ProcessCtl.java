...
public class ProcessCtl implements Runnable
{
	...
	public static ProcessCtl process (ASyncProcess parent, int WindowNo, ProcessInfo processInfo, Trx trx) {
		...
		ProcessModalDialog para = new ProcessModalDialog(SwingEnv.getFrame((Container)parent), WindowNo, processInfo);
	...
	//	log.info("...");
		...
		if (parentProcess != null)
		{
			...
			{
				//swing client
				JFrame frame = SwingEnv.getFrame((Container)parentProcess);
