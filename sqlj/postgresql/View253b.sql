...
/** Product     **/
CREATE OR REPLACE FUNCTION subtractdays (day TIMESTAMP WITH TIME ZONE, days  INTEGER)
RETURNS TIMESTAMP WITH TIME ZONE AS $$
BEGIN
...
SELECT i.AD_Org_ID, i.AD_Client_ID, 
    ...
    i.C_PaymentTerm_ID,
-- e-evolution i.IsPayScheduleValid, null AS C_InvoicePaySchedule_ID
...
AS
-- begin vpj-cd e-evolution 09 Ene 2006 SELECT 	c.AD_Client_ID, c.AD_Org_ID, c.IsActive, 0 AS CreatedBy,SysDate AS Created,0 AS UpdatedBy,SysDate AS Updated,
SELECT 	c.AD_Client_ID, c.AD_Org_ID, c.IsActive, 0 AS CreatedBy,CURRENT_TIMESTAMP AS
Created,0 AS UpdatedBy,CURRENT_TIMESTAMP AS Updated,
...
SELECT AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    R_Request_ID, AD_User_ID, IsSelfService, 
-- e-evolution NULL AS R_Group_ID, NULL AS R_RequestType_ID, NULL AS R_Category_ID
    0 AS R_Group_ID, 0 AS R_RequestType_ID, 0 AS R_Category_ID
FROM R_RequestUpdates
UNION
SELECT u.AD_Client_ID, u.AD_Org_ID, u.IsActive, u.Created, u.CreatedBy, u.Updated, u.UpdatedBy,
...
SELECT MIN(AD_Client_ID) AS AD_Client_ID, MIN(AD_Org_ID) AS AD_ORG_ID, 'Y' AS IsActive, 
    --vpj-cd e-evolution 06 ENE 2006 SysDate AS Created, 0 AS CreatedBy, SysDate AS Updated, 0 AS UpdatedBy,
