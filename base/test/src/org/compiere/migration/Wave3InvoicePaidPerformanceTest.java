...
public class Wave3InvoicePaidPerformanceTest extends CommonGWSetup {
    ...
    private MigrationMode savedPaidMode;
    private MigrationMode savedPaidToDateMode;
    ...
    void loadTestData() {
        ...
        savedPaidMode = MigrationConfig.get("invoicePaid").getMode();
        savedPaidToDateMode = MigrationConfig.get("invoicePaidToDate").getMode();
        setModeInDatabase("invoicePaid", MigrationMode.JAVA_ONLY);
        setModeInDatabase("invoicePaidToDate", MigrationMode.JAVA_ONLY);
    }

    @AfterAll
    void restoreModes() {
        // Restore original modes
        setModeInDatabase("invoicePaid", savedPaidMode);
        setModeInDatabase("invoicePaidToDate", savedPaidToDateMode);
    }
    ...
    void testInvoicePaidPerformance(RepetitionInfo info) {
        ...
        if (info.getCurrentRepetition() == MEASUREMENT_ROUNDS) {
            ...
            System.out.println("\n┌─────────────────────────────────────────────────────────────────────────────┐");
            System.out.println("│ PERFORMANCE: invoicePaid                                                    │");
            System.out.println("├─────────────────────────────────────────────────────────────────────────────┤");
            ...
            assertTrue(passed,
                String.format("invoicePaid: SQL=%.2fms, Java=%.2fms, overhead=%.3fms, ratio=%.2f - %s",
    ...
    void testInvoicePaidToDatePerformance(RepetitionInfo info) {
        ...
        if (info.getCurrentRepetition() == MEASUREMENT_ROUNDS) {
            ...
            System.out.println("\n┌─────────────────────────────────────────────────────────────────────────────┐");
            System.out.println("│ PERFORMANCE: invoicePaidToDate                                              │");
            System.out.println("├─────────────────────────────────────────────────────────────────────────────┤");
            System.out.printf("│ %-20s │ %12s │ %12s │ %12s │ %8s │%n", "Metric", "SQL", "Java", "Diff", "Status");
            System.out.println("├─────────────────────────────────────────────────────────────────────────────┤");
            System.out.printf("│ %-20s │ %9.2f ms │ %9.2f ms │ %+9.2f ms │ %8s │%n",
            ...
            assertTrue(passed,
                String.format("invoicePaidToDate: SQL=%.2fms, Java=%.2fms, overhead=%.3fms, ratio=%.2f - %s",
                    medianSqlMs, medianJavaMs, overheadMs, medianRatio, rule));
        }
    }
}
