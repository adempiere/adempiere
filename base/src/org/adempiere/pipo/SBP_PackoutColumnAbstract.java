...
/** Generated Process for (Packout Column Process)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public abstract class SBP_PackoutColumnAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_PackoutColumn";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Packout Column Process";
	/** Process Id 	*/
