 ...
 */
public abstract class SBP_PackoutTabAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_PackoutTab";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Packout Tab Process";
	/** Process Id 	*/
