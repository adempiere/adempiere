...
public abstract class YearEndClosingAbstract extends SvrProcess {
	...
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54040;
	...
	/**	Parameter Name for TargetAccount_ID	*/
	public static final String TARGETACCOUNT_ID = "TargetAccount_ID";
	...
	private int orgId;
	/**	Parameter Value for TargetAccount_ID	*/
	...
	protected void prepare() {
		...
		targetAccountId = getParameterAsInt(TARGETACCOUNT_ID);
	...
	/**	 Getter Parameter Value for TargetAccount_ID	*/
	protected int getTargetAccountId() {
		return targetAccountId;
	}

	/**	 Setter Parameter Value for TargetAccount_ID	*/
	protected void setTargetAccountId(int targetAccountId) {
