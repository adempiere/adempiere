...
public class X_C_DocBaseType extends PO implements I_C_DocBaseType, I_Persistent 
{
    ...
    public X_C_DocBaseType (Properties ctx, int C_DocBaseType_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_C_DocBaseType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_DocBaseType[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set Accounting Class Name.
		@param AccountingClassname 
		Java Classname
	  */
	public void setAccountingClassname (String AccountingClassname)
	{
		set_Value (COLUMNNAME_AccountingClassname, AccountingClassname);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_AccountingClassname);
	}
	...
	public void setC_DocBaseType_ID (int C_DocBaseType_ID)
	{
		if (C_DocBaseType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_DocBaseType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_DocBaseType_ID, Integer.valueOf(C_DocBaseType_ID));
	}
