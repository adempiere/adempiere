...
// E
	...
	public org.adempiere.core.domains.models.I_EXP_Format getEXP_EmbeddedFormat() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_EXP_Format)MTable.get(getCtx(), org.adempiere.core.domains.models.I_EXP_Format.Table_Name)
	...
	public org.adempiere.core.domains.models.I_EXP_Format getEXP_Format() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_EXP_Format)MTable.get(getCtx(), org.adempiere.core.domains.models.I_EXP_Format.Table_Name)
	...
	/** Set Create if Not Exists.
		@param IsCreateNonExisting 
		Create it if not exists
	  */
	public void setIsCreateNonExisting (boolean IsCreateNonExisting)
	{
		set_Value (COLUMNNAME_IsCreateNonExisting, Boolean.valueOf(IsCreateNonExisting));
	}

	/** Get Create if Not Exists.
		@return Create it if not exists
	  */
	public boolean isCreateNonExisting () 
	{
		Object oo = get_Value(COLUMNNAME_IsCreateNonExisting);
		if (oo != null) 
		{
