...
public class X_T_TrialBalance extends PO implements I_T_TrialBalance, I_Persistent 
{
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_TrialBalance[")
	...
	{
		throw new IllegalArgumentException ("C_Payment_ID is virtual column");	}
	...
	/** Set DateAcct2.
		@param DateAcct2 DateAcct2	  */
	public void setDateAcct2 (Timestamp DateAcct2)
	{
		throw new IllegalArgumentException ("DateAcct2 is virtual column");	}

	/** Get DateAcct2.
		@return DateAcct2	  */
	public Timestamp getDateAcct2 () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DateAcct2);
	}
