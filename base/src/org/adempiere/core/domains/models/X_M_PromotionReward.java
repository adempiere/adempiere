...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM M_PromotionReward WHERE M_Promotion_ID=@M_Promotion_ID@
	...
	public org.adempiere.core.domains.models.I_M_PromotionDistribution getM_PromotionDistribution() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_M_PromotionDistribution)MTable.get(getCtx(), org.adempiere.core.domains.models.I_M_PromotionDistribution.Table_Name)
	...
	public org.adempiere.core.domains.models.I_M_PromotionDistribution getM_TargetDistribution() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_M_PromotionDistribution)MTable.get(getCtx(), org.adempiere.core.domains.models.I_M_PromotionDistribution.Table_Name)
