...
public class X_PA_SLA_Measure extends PO implements I_PA_SLA_Measure, I_Persistent 
{
	...
	public org.adempiere.core.domains.models.I_PA_SLA_Goal getPA_SLA_Goal() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_PA_SLA_Goal)MTable.get(getCtx(), org.adempiere.core.domains.models.I_PA_SLA_Goal.Table_Name)
