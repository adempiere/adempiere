...
public class X_T_OpenItemToDate extends PO implements I_T_OpenItemToDate, I_Persistent 
{
    ...
    {
      super (ctx, T_OpenItemToDate_ID, trxName);
      /** if (T_OpenItemToDate_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_T_OpenItemToDate (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_OpenItemToDate[")
