...
public class X_C_ProjectClass extends PO implements I_C_ProjectClass, I_Persistent 
{
    ...
    public X_C_ProjectClass (Properties ctx, int C_ProjectClass_ID, String trxName)
    {
      ...
      /** if (C_ProjectClass_ID == 0)
        {
			setC_ProjectClass_ID (0);
			setName (null);
        } */
    }

    /** Load Constructor */
    public X_C_ProjectClass (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_ProjectClass[")
	...
	public void setC_ProjectClass_ID (int C_ProjectClass_ID)
	{
		if (C_ProjectClass_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_ProjectClass_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_ProjectClass_ID, Integer.valueOf(C_ProjectClass_ID));
	}
	...
	public org.adempiere.core.domains.models.I_C_ProjectClass getProjectClassParent() throws RuntimeException
    {
	...
	/** Set Project Class Parent.
		@param ProjectClassParent_ID 
		Project Class Parent
	  */
	public void setProjectClassParent_ID (int ProjectClassParent_ID)
	{
		if (ProjectClassParent_ID < 1) 
			set_Value (COLUMNNAME_ProjectClassParent_ID, null);
		else 
			set_Value (COLUMNNAME_ProjectClassParent_ID, Integer.valueOf(ProjectClassParent_ID));
	}

	/** Get Project Class Parent.
		@return Project Class Parent
	  */
	public int getProjectClassParent_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ProjectClassParent_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getProjectClassParent_ID()));
    }
