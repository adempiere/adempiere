...
public class X_I_ProductPlanning extends PO implements I_I_ProductPlanning, I_Persistent 
{
    ...
    {
		return (org.adempiere.core.domains.models.I_DD_NetworkDistribution)MTable.get(getCtx(), org.adempiere.core.domains.models.I_DD_NetworkDistribution.Table_Name)
	...
	public org.adempiere.core.domains.models.I_PP_Product_Planning getPP_Product_Planning() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_PP_Product_Planning)MTable.get(getCtx(), org.adempiere.core.domains.models.I_PP_Product_Planning.Table_Name)
