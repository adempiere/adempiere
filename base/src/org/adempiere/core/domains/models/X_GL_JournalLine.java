...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM GL_JournalLine WHERE GL_Journal_ID=@GL_Journal_ID@
	...
	public org.adempiere.core.domains.models.I_C_ValidCombination getAlias_ValidCombination() throws RuntimeException
    {
	...
	public org.adempiere.core.domains.models.I_GL_JournalLine getReversalLine() throws RuntimeException
    {
