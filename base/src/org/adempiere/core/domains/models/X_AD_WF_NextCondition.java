...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_WF_NextCondition WHERE AD_WF_NodeNext_ID=@AD_WF_NodeNext_ID@
	...
	public org.adempiere.core.domains.models.I_AD_WF_NodeNext getAD_WF_NodeNext() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_AD_WF_NodeNext)MTable.get(getCtx(), org.adempiere.core.domains.models.I_AD_WF_NodeNext.Table_Name)
