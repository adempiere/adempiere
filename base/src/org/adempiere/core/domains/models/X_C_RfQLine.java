...
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM C_RfQLine WHERE C_RfQ_ID=@C_RfQ_ID@
	...
	public org.adempiere.core.domains.models.I_C_RfQ getC_RfQ() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_RfQ)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_RfQ.Table_Name)
