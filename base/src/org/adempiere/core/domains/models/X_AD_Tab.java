...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Tab WHERE AD_Window_ID=@AD_Window_ID@
	...
	public org.adempiere.core.domains.models.I_AD_Column getAD_ColumnSortYesNo() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_AD_Column)MTable.get(getCtx(), org.adempiere.core.domains.models.I_AD_Column.Table_Name)
	...
	public org.adempiere.core.domains.models.I_AD_Tab getIncluded_Tab() throws RuntimeException
    {
