...
public class X_C_RfQ_TopicSubscriberOnly extends PO implements I_C_RfQ_TopicSubscriberOnly, I_Persistent 
{
	...
	public org.adempiere.core.domains.models.I_C_RfQ_TopicSubscriber getC_RfQ_TopicSubscriber() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_RfQ_TopicSubscriber)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_RfQ_TopicSubscriber.Table_Name)
