...
public class X_C_ServiceLevelLine extends PO implements I_C_ServiceLevelLine, I_Persistent 
{
	...
	public org.adempiere.core.domains.models.I_C_ServiceLevel getC_ServiceLevel() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_ServiceLevel)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_ServiceLevel.Table_Name)
