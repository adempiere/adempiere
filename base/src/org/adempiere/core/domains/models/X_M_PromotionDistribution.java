...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM M_PromotionDistribution WHERE M_Promotion_ID=@M_Promotion_ID@
	...
	public org.adempiere.core.domains.models.I_M_PromotionLine getM_PromotionLine() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_M_PromotionLine)MTable.get(getCtx(), org.adempiere.core.domains.models.I_M_PromotionLine.Table_Name)
