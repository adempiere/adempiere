...
/** Generated Model for ASP_Level_Access
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4 - $Id$ */
public class X_ASP_Level_Access extends PO implements I_ASP_Level_Access, I_Persistent 
{
    ...
    public X_ASP_Level_Access (Properties ctx, int ASP_Level_Access_ID, String trxName)
    {
      super (ctx, ASP_Level_Access_ID, trxName);
      /** if (ASP_Level_Access_ID == 0)
        {
			setAD_Role_ID (0);
			setASP_Level_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_ASP_Level_Access (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_ASP_Level_Access[")
