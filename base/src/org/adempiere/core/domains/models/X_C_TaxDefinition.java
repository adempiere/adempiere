...
public class X_C_TaxDefinition extends PO implements I_C_TaxDefinition, I_Persistent 
{
	...
	public org.adempiere.core.domains.models.I_C_TaxBase getC_TaxBase() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_TaxBase)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_TaxBase.Table_Name)
