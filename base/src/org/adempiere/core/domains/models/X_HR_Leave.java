...
public class X_HR_Leave extends PO implements I_HR_Leave, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_HR_Leave (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Leave[")
    ...
    {
		return (org.adempiere.core.domains.models.I_HR_LeaveAssign)MTable.get(getCtx(), org.adempiere.core.domains.models.I_HR_LeaveAssign.Table_Name)
    ...
    {
		return (org.adempiere.core.domains.models.I_HR_LeaveReason)MTable.get(getCtx(), org.adempiere.core.domains.models.I_HR_LeaveReason.Table_Name)
	...
	/** Set No Of Leaves Credited.
	  ...
	  */
	public void setNoOfLeavesCredited (int NoOfLeavesCredited)
	{
		set_Value (COLUMNNAME_NoOfLeavesCredited, Integer.valueOf(NoOfLeavesCredited));
	}

	/** Get No Of Leaves Credited.
		@return No Of Leaves Credited
	  */
	public int getNoOfLeavesCredited () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_NoOfLeavesCredited);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
