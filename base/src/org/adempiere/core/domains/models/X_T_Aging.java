...
// 1
			...
			setPastDue120_180 (Env.ZERO);
// 0
			setPastDue180_360 (Env.ZERO);
// 0
...
// 0
	...
	public org.adempiere.core.domains.models.I_C_CashFlow getC_CashFlow() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_CashFlow)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_CashFlow.Table_Name)
	...
	{
		set_Value (COLUMNNAME_PastDue120_180, PastDue120_180);
	}
	...
	{
		set_Value (COLUMNNAME_PastDue180_360, PastDue180_360);
	}
	...
	{
		set_Value (COLUMNNAME_PastDue90_120, PastDue90_120);
	}
