...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_MigrationStep WHERE AD_Migration_ID=@AD_Migration_ID@
	...
	public org.adempiere.core.domains.models.I_AD_Migration getAD_Migration() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_AD_Migration)MTable.get(getCtx(), org.adempiere.core.domains.models.I_AD_Migration.Table_Name)
