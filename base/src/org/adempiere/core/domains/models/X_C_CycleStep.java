...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM C_CycleStep WHERE C_Cycle_ID=@C_Cycle_ID@
	...
	public org.adempiere.core.domains.models.I_C_Cycle getC_Cycle() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_C_Cycle)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_Cycle.Table_Name)
