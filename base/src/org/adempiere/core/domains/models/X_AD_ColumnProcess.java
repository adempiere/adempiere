...
public class X_AD_ColumnProcess extends PO implements I_AD_ColumnProcess, I_Persistent 
{
    ...
    {
      super (ctx, AD_ColumnProcess_ID, trxName);
      /** if (AD_ColumnProcess_ID == 0)
        {
			setAD_ColumnProcess_ID (0);
        } */
    }

    /** Load Constructor */
    public X_AD_ColumnProcess (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_ColumnProcess[")
