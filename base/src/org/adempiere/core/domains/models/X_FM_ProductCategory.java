...
/** Generated Model for FM_ProductCategory
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4 - $Id$ */
public class X_FM_ProductCategory extends PO implements I_FM_ProductCategory, I_Persistent 
{
    ...
    public X_FM_ProductCategory (Properties ctx, int FM_ProductCategory_ID, String trxName)
    {
      super (ctx, FM_ProductCategory_ID, trxName);
      /** if (FM_ProductCategory_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_FM_ProductCategory (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FM_ProductCategory[")
	...
	/** Type AD_Reference_ID=54011 */
	public static final int TYPE_AD_Reference_ID=54011;
	/** Loan = L */
	public static final String TYPE_Loan = "L";
	/** Set Type.
		@param Type 
