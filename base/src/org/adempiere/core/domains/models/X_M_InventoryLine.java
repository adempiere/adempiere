...
// @M_Locator_ID@
	...
	{
		throw new IllegalArgumentException ("Discontinued is virtual column");	}
	...
	/** Set First Count Qty.
		@param FirstCountQty First Count Qty	  */
	public void setFirstCountQty (BigDecimal FirstCountQty)
	{
		set_Value (COLUMNNAME_FirstCountQty, FirstCountQty);
	}

	/** Get First Count Qty.
		@return First Count Qty	  */
	public BigDecimal getFirstCountQty () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_FirstCountQty);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		throw new IllegalArgumentException ("LocatorValue is virtual column");	}
	...
	/** Set Second Count Qty.
		@param SecondCountQty Second Count Qty	  */
	public void setSecondCountQty (BigDecimal SecondCountQty)
	{
		set_Value (COLUMNNAME_SecondCountQty, SecondCountQty);
	}

	/** Get Second Count Qty.
		@return Second Count Qty	  */
	public BigDecimal getSecondCountQty () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_SecondCountQty);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		throw new IllegalArgumentException ("UOMSymbol is virtual column");	}
	...
	{
		throw new IllegalArgumentException ("X is virtual column");	}
