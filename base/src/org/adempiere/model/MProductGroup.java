...
public class MProductGroup extends X_M_Product_Group {

	public MProductGroup(Properties ctx, int M_Product_Group_ID, String trxName) {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1965363199290247144L;
