...
public abstract class RequestEMailProcessorAbstract extends SvrProcess {
	...
	/**	Parameter Name for IMAP User	*/
	public static final String REQUESTUSER = "RequestUser";
	/**	Parameter Name for IMAP Password	*/
	...
	/**	Parameter Name for User Importance	*/
	...
	/**	Parameter Value for IMAP User	*/
	private String requestUser;
	/**	Parameter Value for IMAP Password	*/
	...
	/**	Parameter Value for User Importance	*/
	...
	/**	 Getter Parameter Value for IMAP User	*/
	protected String getRequestUser() {
		return requestUser;
	}

	/**	 Setter Parameter Value for IMAP User	*/
	protected void setRequestUser(String requestUser) {
		this.requestUser = requestUser;
	}

	/**	 Getter Parameter Value for IMAP Password	*/
	protected String getRequestUserPW() {
		return requestUserPW;
	}

	/**	 Setter Parameter Value for IMAP Password	*/
	...
	/**	 Getter Parameter Value for User Importance	*/
	protected String getPriorityRule() {
		return priorityRule;
	}

	/**	 Setter Parameter Value for User Importance	*/
