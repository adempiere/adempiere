...
/** Generated Process for (Generate Receipt from Invoice)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public abstract class InvoiceCreateInOutAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_Invoice_CreateInOut";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Receipt from Invoice";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 142;
