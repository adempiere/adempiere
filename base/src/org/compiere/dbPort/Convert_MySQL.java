 ...
 */
public class Convert_MySQL extends Convert_SQL92 {

    /**
	 * Constructor
	 */
	public Convert_MySQL() {
		m_map = ConvertMap_MySQL.getConvertMap();
	} // Convert
	...
	/** Logger */
	private static CLogger log = CLogger.getCLogger(Convert_MySQL.class);
