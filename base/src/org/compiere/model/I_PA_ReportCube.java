...
public interface I_PA_ReportCube 
{
    ...
    /** Column name IsUser3Dim */
    public static final String COLUMNNAME_IsUser3Dim = "IsUser3Dim";
    ...
    /** Column name IsUser4Dim */
    public static final String COLUMNNAME_IsUser4Dim = "IsUser4Dim";
