...
// @#Date@
	...
	/** Set Create lines from Invoice.
		@param CreateFromInvoice 
		Process which will generate a new document lines based on an existing document
	  */
	public void setCreateFromInvoice (String CreateFromInvoice)
	{
		set_Value (COLUMNNAME_CreateFromInvoice, CreateFromInvoice);
	}

	/** Get Create lines from Invoice.
		@return Process which will generate a new document lines based on an existing document
	  */
	public String getCreateFromInvoice () 
	{
		return (String)get_Value(COLUMNNAME_CreateFromInvoice);
	}

	/** Set Create lines from Order.
		@param CreateFromOrder 
		Process which will generate a new document lines based on an existing document
	  */
	public void setCreateFromOrder (String CreateFromOrder)
	{
		set_Value (COLUMNNAME_CreateFromOrder, CreateFromOrder);
	}

	/** Get Create lines from Order.
		@return Process which will generate a new document lines based on an existing document
	  */
	public String getCreateFromOrder () 
	{
		return (String)get_Value(COLUMNNAME_CreateFromOrder);
	}
