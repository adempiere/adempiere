...
public class X_C_StandardProjectLine extends PO implements I_C_StandardProjectLine, I_Persistent 
{
    ...
    public X_C_StandardProjectLine (Properties ctx, int C_StandardProjectLine_ID, String trxName)
    {
      ...
      /** if (C_StandardProjectLine_ID == 0)
        {
			setC_ProjectLineType_ID (0);
			setC_ProjectType_ID (0);
			setC_StandardProjectLine_ID (0);
			setName (null);
			setSeqNo (0);
...
// 1
    ...
    /** Load Constructor */
    public X_C_StandardProjectLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_StandardProjectLine[")
