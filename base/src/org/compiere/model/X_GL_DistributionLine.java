...
public static final int C_LOCTO_ID_AD_Reference_ID=133;
	...
	public I_GL_Distribution getI_GL_Distribution() throws Exception 
    {
        ...
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_GL_Distribution)constructor.newInstance(new Object[] {getCtx(), new Integer(getGL_Distribution_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw e;
