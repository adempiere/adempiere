...
// U
	...
	public void setShowHelp (String ShowHelp)
	{
		...
		if (ShowHelp == null || ShowHelp.equals("A") || ShowHelp.equals("N") || ShowHelp.equals("Y") || ShowHelp.equals("S")); else throw new IllegalArgumentException ("ShowHelp Invalid value - " + ShowHelp + " - Reference_ID=50007 - A - N - Y - S");		set_Value (COLUMNNAME_ShowHelp, ShowHelp);
	}
