...
public class X_PA_Measure extends PO implements I_PA_Measure, I_Persistent 
{
    ...
    public X_PA_Measure (Properties ctx, int PA_Measure_ID, String trxName)
    {
      ...
      /** if (PA_Measure_ID == 0)        {			setMeasureDataType (null);
// T
			setMeasureType (null);
// M
			setName (null);
...
public static final int MEASUREDATATYPE_AD_Reference_ID=369;/** Status Qty/Amount = S */
public static final String MEASUREDATATYPE_StatusQtyAmount = "S";/** Qty/Amount in Time = T */
public static final String MEASUREDATATYPE_QtyAmountInTime = "T";
	...
	{
if (MeasureDataType == null) throw new IllegalArgumentException ("MeasureDataType is mandatory");if (MeasureDataType.equals("S") || MeasureDataType.equals("T")); else throw new IllegalArgumentException ("MeasureDataType Invalid value - " + MeasureDataType + " - Reference_ID=369 - S - T");		if (MeasureDataType.length() > 1)
		{
...
public static final int MEASURETYPE_AD_Reference_ID=231;/** Achievements = A */
public static final String MEASURETYPE_Achievements = "A";/** Calculated = C */
public static final String MEASURETYPE_Calculated = "C";/** Manual = M */
public static final String MEASURETYPE_Manual = "M";/** Project = P */
public static final String MEASURETYPE_Project = "P";/** Request = Q */
public static final String MEASURETYPE_Request = "Q";/** Ratio = R */
public static final String MEASURETYPE_Ratio = "R";/** User defined = U */
