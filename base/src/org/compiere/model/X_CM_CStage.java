...
public class X_CM_CStage extends PO implements I_CM_CStage, I_Persistent 
{
    ...
    public X_CM_CStage (Properties ctx, int CM_CStage_ID, String trxName)
    {
      ...
      /** if (CM_CStage_ID == 0)        {			setCM_CStage_ID (0);
...
public static final int CM_CSTAGELINK_ID_AD_Reference_ID=387;
	...
	{
		if (CM_CStageLink_ID <= 0) 		set_Value (COLUMNNAME_CM_CStageLink_ID, null);
 else 
	...
	{
		if (CM_Template_ID <= 0) 		set_Value (COLUMNNAME_CM_Template_ID, null);
 else 
