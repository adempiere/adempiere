 ...
 * Treee Node 2
 */
public class MTree_NodeU2 extends X_AD_TreeNodeU2 {
     ...
     */
    public static List<MTree_NodeU2> getTree(Properties ctx, int treeId, String trxName) {
    ...
    /**    Static Logger	*/
    private static CLogger logger = CLogger.getCLogger(MTree_NodeU2.class);
     ...
     *	@param trxName transaction
     */
    public MTree_NodeU2(Properties ctx, ResultSet rs, String trxName) {
