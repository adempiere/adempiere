...
// N
	...
	/** Set ActualGT.
		@param ActualGT ActualGT	  */
	public void setActualGT (BigDecimal ActualGT)
	{
		set_Value (COLUMNNAME_ActualGT, ActualGT);
	}

	/** Get ActualGT.
		@return ActualGT	  */
	public BigDecimal getActualGT () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ActualGT);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set RAmount.
		@param RAmount RAmount	  */
	public void setRAmount (BigDecimal RAmount)
	{
		set_Value (COLUMNNAME_RAmount, RAmount);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_RAmount);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** RType AD_Reference_ID=1000038 */
	public static final int RTYPE_AD_Reference_ID=1000038;
	/** Upper Round = U */
	public static final String RTYPE_UpperRound = "U";
	/** Lower Round = L */
	public static final String RTYPE_LowerRound = "L";
	/** None = N */
	public static final String RTYPE_None = "N";
	/** Set RType.
		@param RType RType	  */
	public void setRType (String RType)
	{

		set_Value (COLUMNNAME_RType, RType);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_RType);
	}
