...
/** Generated Process for (Manage Activity)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public abstract class WFActivityManageAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "AD_WF_Activity_Manage";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Manage Activity";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 278;
