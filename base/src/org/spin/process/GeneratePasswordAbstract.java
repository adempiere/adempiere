 ...
 */
public abstract class GeneratePasswordAbstract  {
	/** Process Value 	*/
	...
	public static final String DATETRX = "UserName";
	...
	protected void setUserName(String dateTrx) {
		this.userName = dateTrx;
	}
