 ...
 */
public abstract class GenerateInvoiceFromSalesOrdersAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_GenerateInvoiceFromSalesOrders";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Invoices from Sales Orders";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54439;
