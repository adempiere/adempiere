 ...
 */
public abstract class CopyWindowFromRoleAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_RoleCopyWindow";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Window From Role";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54399;
