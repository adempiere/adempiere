 ...
 */
public abstract class CopyBrowserFromRoleAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_RoleCopyBrowser";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Browser From Role";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54400;
