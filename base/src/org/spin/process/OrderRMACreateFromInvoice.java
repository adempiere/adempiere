...
public class OrderRMACreateFromInvoice extends OrderRMACreateFromInvoiceAbstract {
	...
	protected String doIt() throws Exception {
		...
		recordIds.stream().forEach( key -> {
			...
			MInvoiceLine invoiceLine = new MInvoiceLine(getCtx(), key, get_TrxName());
			//	Get source Order
			MOrderLine sourceOrderLine = (MOrderLine) invoiceLine.getC_OrderLine();
			//	Change header
			...
			//	Set Reference
			orderLine.setRef_InvoiceLine(invoiceLine);
