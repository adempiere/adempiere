...
public class X_AD_Queue extends PO implements I_AD_Queue, I_Persistent 
{
	...
	public org.spin.queue.model.I_AD_QueueType getAD_QueueType() throws RuntimeException
    {
		return (org.spin.queue.model.I_AD_QueueType)MTable.get(getCtx(), org.spin.queue.model.I_AD_QueueType.Table_Name)
