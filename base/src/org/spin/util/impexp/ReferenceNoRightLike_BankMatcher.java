...
/**
 * Add matcher by reference with right like
 * @author Yamel Senih, ysenih@erpya.com , http://www.erpya.com
 * <li> FR [ 1807 ] Add Match class for Reference No
 * @see https://github.com/adempiere/adempiere/issues/1807
 */
public class ReferenceNoRightLike_BankMatcher implements BankStatementMatcherInterface {

	public ReferenceNoRightLike_BankMatcher() {
