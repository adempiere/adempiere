...
public class X_FM_Status extends PO implements I_FM_Status, I_Persistent 
{
	...
	public org.spin.model.I_FM_Transaction getFM_Transaction() throws RuntimeException
    {
		return (org.spin.model.I_FM_Transaction)MTable.get(getCtx(), org.spin.model.I_FM_Transaction.Table_Name)
