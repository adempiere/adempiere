...
public class ReportDateManager 
{
	...
	public static Date getStartDateForPeriod(String period) throws OperationException
	{
	...
	public static Date getEndDateForPeriod(String period)
	{
		Calendar cal = Calendar.getInstance();		
		return cal.getTime();
	}
	...
	public static String getFromDate(ReportBean reportBean) throws InvalidMonthException
    {
        String delimiter = "/";
    ...
    public static String getToDate(ReportBean reportBean) throws InvalidMonthException
    {
        String delimiter = "/";
