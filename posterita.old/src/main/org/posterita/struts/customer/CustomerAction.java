...
import org.posterita.businesslogic.CustomerManager;
...
public class CustomerAction extends BaseDispatchAction
{
	...
	public 	ActionForward getAllPOSCustomer(ActionMapping mapping, ActionForm form,HttpServletRequest request,HttpServletResponse response) throws ApplicationException, OperationException
	{
