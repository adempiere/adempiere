...
<bean:define id="title"><pos:element textOnly="true" columnName="attribute"/></bean:define>
		...
		<tr>
			<td>
				...
				<html:hidden property="attributeValueId"/>
					<table>
						<tr>
							<td><label><pos:element columnName="old.attribute.value"/>:</label></td>
							<td><html:text property="name" readonly="true" styleClass="text"></html:text>
						</tr>
						<tr>
							<td><label><pos:element columnName="new.attribute.value"/>:</label></td>
