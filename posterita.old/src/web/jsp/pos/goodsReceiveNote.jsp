...
<bean:define id="title"><pos:element textOnly="true" columnName="goods.received.note"/></bean:define>

<table width="100%">
	<td align="right">
		<html:link href="<%="CreateNewOrderAction.do?action=removeSessionForNewOrder&orderType=" + UDIOrderTypes.POS_GOODS_RECEIVE_NOTE.getOrderType() %>">
			Create New
		</html:link>			
	</td>
</table>
...
<table class="main">
	...
	<tr>
   		...
   		<div id="searchPanel">
			...
			<tr>
				<td>
					<label><pos:element columnName="vendor.ref"/>:</label>	
				</td>
				<td colspan="1" align="left">
					<html:text property="description" styleClass="text" accesskey="r"/>					
				</td>				
				<td colspan="3" align="right">
					<label><pos:element columnName="Vendor_ID"/>:</label>
	...
	<tr>					  
		<td align="center">
			<span>
				...
				<span class="shortcutkey">
					<label><pos:element columnName="continue"/>-</label>
