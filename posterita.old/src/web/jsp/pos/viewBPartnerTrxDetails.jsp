...
<bean:define id="title"><pos:element columnName="bpartner.trx.details" textOnly="true"/></bean:define>
...
<table class="display" border="0">
	...
	<tr>
		<td align="left">
		  <b><pos:element columnName="Name"/>: <bean:write name="element" property="partnerName"/></b>	
		</td>
	</tr>
	<tr>
		<td align="left">
		  <b><pos:element columnName="OpenAmt"/>: <bean:write name="element" property="openAmt"/></b>	
		</td>
	</tr>
	<tr>
		<td>
		 <b><pos:element columnName="SO_CreditUsed"/>: <bean:write name="element" property="creditUsed"/></b>	
		</td>
	</tr>
	<tr>
		<td>
		  <b><pos:element columnName="SO_CreditLimit"/>: <bean:write name="element" property="creditLimit"/></b>	
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
		  <b><pos:element columnName="SOCreditStatus"/>: <bean:write name="element" property="soCreditStatus"/></b>	
		</td>
	</tr>
	<tr>
		<td>
		  <b><pos:element columnName="FirstSale"/>: <bean:write name="element" property="bpfirstSale"/></b>	
		</td>
	</tr>
</table>
</logic:iterate>
...
<table class="display" border="1">
	...
	<tr>
		<th><pos:element columnName="Product"/></th>
		<th><pos:element columnName="Qty"/></th>
		<th><pos:element columnName="TotalAmt"/></th>		
	</tr>	
...
<table class="display sortable" border="1" id="1111">	
	...
	<tr>		
		...
		<th><pos:element columnName="date.created"/></th>
		<th><pos:element columnName="customervendor"/></th>
		<th><pos:element columnName="OrderType"/></th>
		<th><pos:element columnName="Grandtotal"/></th>
	</tr>	
