...
<bean:define id="title"><pos:element columnName="payment.details" textOnly="true"/></bean:define>
...
<tr>
			<td>
				...
				<tr>
						<th>
							<pos:element columnName="Date1"/>
						</th>
						
						<th>
							<pos:element columnName="DocumentNo"/>
						</th>
						
						<th>
							<pos:element columnName="TenderType"/>
						</th>
						<th>
							<pos:element columnName="cheque.no"/>.
						</th>
					
						<th>
							<pos:element columnName="card.no"/>
						</th>
					
						<th>
							<pos:element columnName="discount.amt"/>
						</th>

						<th>
							<pos:element columnName="PaidAmt"/>
						</th>
						
						<th>
							<pos:element columnName="WriteOffAmt"/>
						</th>
