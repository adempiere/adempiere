...
<bean:define id="title"><pos:element columnName="payment.terms" textOnly="true"/></bean:define>
...
<table class="display sortable" border="1" id="1111"> 		
	<tr>
		<th align="left"><pos:element columnName="Name"/></th>
		<th><pos:element columnName="NetDays"/></th>
		<th><pos:element columnName="IsDueFixed"/></th>
		<th><pos:element columnName="FixMonthDay"/></th>
		<th><pos:element columnName="FixMonthOffset"/></th>
		<th><pos:element columnName="FixMonthCutoff"/></th>
		<th><pos:element columnName="AfterDelivery"/></th>
