...
<html> 
	<head>		
		<title><pos:element textOnly="true" columnName="print.order"/></title>							
	...
	<tr>
		<td>
			<pos:element columnName="DocStatus"/>:<dcs:orderStatus name="<%=Constants.MORDER%>" property="docStatus"/>
		</td>
	</tr>
	</table>
