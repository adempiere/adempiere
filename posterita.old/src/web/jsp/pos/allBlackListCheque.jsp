...
<bean:define id="title"><pos:element textOnly="true" columnName="black.listed.cheques"/></bean:define>
...
<div align="right">
	<TABLE>
		<tr>
		<td>
			<html:link href="/jsp/pos/createBlackListCheque.jsp"> <pos:element columnName="add.record"/> </html:link>
		</td>
		</tr>
		<tr>
		<!-- 
		<td>
			<html:link href="/jsp/pos/importBlackList.jsp"> <pos:element columnName="import.list"/> </html:link>
		</td> -->
...
<logic:empty name="<%=Constants.BLACKLISTED_LISTS%>">
	<div><pos:element columnName="no.customer.was.found.for"/><b><bean:write name="BlackListForm" property="blackListedChequeNo"/></b></div>
	<div class="space"></div>
</logic:empty>
...
<tr>
	<th><pos:element columnName="BankName"/></th>
	<th><pos:element columnName="CheckNo"/></th>
	<th>&nbsp;</th>
</tr>
