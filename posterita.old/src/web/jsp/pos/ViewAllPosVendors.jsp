...
<bean:define id="title"><pos:element columnName="vendors" textOnly="true"/></bean:define>
...
<logic:empty name="<%=Constants.VENDOR_LIST%>">
	<div><pos:element columnName="no.vendor.was.found.for"/>: <b><bean:write name="DefaultForm" property="name"/></b></div>
	<div class="space"></div>
</logic:empty>
</logic:present>
...
<bean:define id="editmsg">
	<pos:element columnName="edit.vendor" textOnly="true"/>
</bean:define>
<bean:define id="viewmsg">
	<pos:element columnName="view.vendor" textOnly="true"/>
</bean:define>
<bean:define id="activatemsg">
	<pos:element columnName="activate.vendor" textOnly="true"/>
</bean:define>
<bean:define id="deactivatemsg">
	<pos:element columnName="deactivate.vendor" textOnly="true"/>
</bean:define>
