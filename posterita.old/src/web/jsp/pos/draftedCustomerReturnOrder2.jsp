...
<bean:define id="title"><pos:element textOnly="true" columnName="customer.returned.order"/></bean:define>
...
<div align="center">
	<table border="0" cellpadding="10" align="center">
		<tr align="center">
			<td>
				<label><pos:element columnName="IsComplete"/> -</label><label class="red">Alt-C</label> 
			</td>
			<td>
