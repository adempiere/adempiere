...
<bean:define id="title"><pos:element columnName="smenu.payment.allocation.history" textOnly="true"/></bean:define>
...
<table class="display" border="0"> 	
		...
		<tr>
			<td>
				<pos:element columnName="invoice.no"/>:<html:text property ="invoiceNo"/>
			
				&nbsp;

				<pos:element columnName="Name"/>: <html:text property ="partnerName"/>
...
<logic:empty name="<%=Constants.PAYMENT_ALLOCATIONS%>">
	<pos:element columnName="no.allocation.found" textOnly="true"/>
</logic:empty>
...
<table class="display sortable" border="1" id="1111">
	<tr>
		...
		<th><pos:element columnName="C_Order_ID"/></th>
		<th><pos:element columnName="C_Invoice_ID"/></th>
		<th><pos:element columnName="C_Payment_ID"/></th>
		<th><pos:element columnName="cash.payment"/></th>
		<th>memo</th>
		<th><pos:element columnName="Amount"/></th>
		<th><pos:element columnName="DiscountAmt"/></th>
		<th><pos:element columnName="WriteOffAmt"/></th>
		<th><pos:element columnName="OverUnderAmt"/></th>
