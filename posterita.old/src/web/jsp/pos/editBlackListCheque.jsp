...
<bean:define id="title"><pos:element textOnly="true" columnName="edit.black.listed.cheque"/></bean:define>
...
<table width="40%" class="view">
	<tr>
		<td>
			...
			<tr>
				<td>
					<label><pos:element columnName="ChequeNo"/>><mandatory>*</mandatory>
				</td>
