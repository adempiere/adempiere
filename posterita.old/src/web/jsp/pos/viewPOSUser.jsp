...
<bean:define id="title"><pos:element columnName="user.details" textOnly="true"/></bean:define>
		...
		<td width="50%">
			<fieldset>
				...
				<table>
					...
					<tr>
						<td>
							<label><pos:element columnName="AD_Role_ID"/></label>
						</td>
				...
				<table>
					...
					<tr>
						<td>
							<label><pos:element columnName="Address1"/></label>
						</td>
					...
					<tr>
						<td>
							<label><pos:element columnName="City"/></label>
						</td>
					...
					<tr>
						<td>
							<label><pos:element columnName="Postal"/></label>
						</td>
					...
					<tr>
						<td>
							<label><pos:element columnName="regionName"/></label>
						</td>
					...
					<tr>
						<td>
							<label><pos:element columnName="EMail"/></label>
						</td>
						<td>
					...
					<tr>
						<td>
							<label><pos:element columnName="Phone"/></label>
						</td>
						<td>
				...
				<table>
					<tr>
						<td>
							<label><pos:element columnName="UserDiscount"/></label>
						</td>
											
						<td>
							<label><bean:write name="<%=Constants.USER_DETAILS%>" property="userDiscount"/></label>
						</td>
					</tr>
