...
<logic:empty name="<%=Constants.PRODUCT_CART_ITEMS%>">
	...
	<div class="space"></div>
	<div>
		<a href="ViewAllPOSProductsForUpdate.do"><pos:element columnName="cart.addmore" textOnly="true"/></a>			
	</div>
</logic:empty>
...
<form>
	<logic:present name="<%= Constants.PRODUCT_CART %>">		
		<span id="productCount">
			...
			</strong><pos:element columnName="items" textOnly="true"/>
		</span>		
	</logic:present>
...
<div class="scrollpane">	
	<table class="display" border="1">
		<tr>
			<th><pos:element columnName="Name" textOnly="true"/></th>
	   	    <th nowrap="nowrap"><pos:element columnName="purchase.price" textOnly="true"/></th>  
	   	    <th nowrap="nowrap"><pos:element columnName="sales.price" textOnly="true"/></th>   
	   	    <th nowrap="nowrap">&nbsp;</th>
	 	</tr>		
...
<html:form action="/CreateCSVFileAction">
	...
	<html:submit>
		<pos:element columnName="download.csv" textOnly="true"/>
	</html:submit>		
</html:form>  		 	
</logic:notEmpty>
</logic:present> 
