...
<bean:define id="title"><pos:element textOnly="true" columnName="C_Tax_ID"/></bean:define>
...
<table class="display sortable" border="1" id="1111"> 		
	<tr>
		<th align="left"><pos:element columnName="C_Tax_ID"/></th>
		<th><pos:element columnName="Description"/></th>
		<th><pos:element columnName="Rate"/></th>
		<th><pos:element columnName="IsTaxExempt"/></th>
