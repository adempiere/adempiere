...
public abstract class RollupBillOfMaterialAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "PP_Bill of Material Cost Roll-UP";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Bill of Material & Formula Cost Roll-UP";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 53062;
	...
	/**	Parameter Name for Product Type	*/
	...
	/**	Parameter Value for Product Type	*/
	...
	/**	 Getter Parameter Value for Product Type	*/
	protected String getProductType() {
		return productType;
	}

	/**	 Setter Parameter Value for Product Type	*/
