...
public abstract class FrozenUnFrozenCostAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "PP_Cost Frozen/UnFrozen";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Frozen/UnFrozen Cost";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 53160;
	...
	/**	Parameter Name for Cost Frozen	*/
	private static final String ISCOSTFROZEN = "IsCostFrozen";
	...
	/**	Parameter Value for Cost Frozen	*/
	...
	/**	 Getter Parameter Value for Cost Frozen	*/
	protected boolean isCostFrozen() {
		return isCostFrozen;
	}

	/**	 Setter Parameter Value for Cost Frozen	*/
	protected void setIsCostFrozen(boolean isCostFrozen) {
