...
WILDFLY_BASE=@ADEMPIERE_HOME@/wildfly
export WILDFLY_BASE

CATALINA_BASE=@ADEMPIERE_HOME@/tomcat
export CATALINA_BASE

JETTY_BASE=@ADEMPIERE_HOME@/jetty
export JETTY_BASE
...
ADEMPIERE_JAVA_OPTIONS="-Dfile.encoding=UTF-8 -Xms128m -Xmx1512m -XX:PermSize=64m -XX:MaxPermSize=256m --add-exports java.base/jdk.internal.misc=ALL-UNNAMED --add-opens java.base/java.lang=ALL-UNNAMED -DADEMPIERE_HOME=$ADEMPIERE_HOME"
