...
import org.adempiere.apps.form.InvoiceGenFromShipment;
...
/**
 * Generate Invoice view class
 * 
 */
public class WInvoiceGenFromShipment extends InvoiceGenFromShipment implements IFormController, EventListener, ValueChangeListener
{
	...
	/** Match Options           */
	private String[] m_YesNo = new String[] {
		Msg.getElement(Env.getCtx(), "Yes", false),
		Msg.getElement(Env.getCtx(), "No", false)};
	//
	...
	public WInvoiceGenFromShipment()
	{
		log.info("");
