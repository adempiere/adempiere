...
$JAVA --add-opens java.base/sun.security.tools.keytool=ALL-UNNAMED -classpath $CP -DADEMPIERE_HOME=$ADEMPIERE_HOME -Dant.home="." org.apache.tools.ant.launch.Launcher update
