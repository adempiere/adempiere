...
public class X_FM_Batch extends PO implements I_FM_Batch, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20180508L;
...
// N
    ...
    /** Load Constructor */
    public X_FM_Batch (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FM_Batch[")
    ...
    {
		return (org.spin.model.I_FM_FunctionalSetting)MTable.get(getCtx(), org.spin.model.I_FM_FunctionalSetting.Table_Name)
	...
	public org.spin.model.I_FM_Batch getReversal() throws RuntimeException
    {
