CREATE OR REPLACE VIEW RV_Invoice_CreateFrom 
(AD_Client_ID, AD_Org_ID, CreatedBy, Created, UpdatedBy, Updated, IsActive, RV_Invoice_CreateFrom_ID, Line, 
QtyEntered, C_UOM_ID, MovementQty, Multiplier, Name, M_Product_ID, M_AttributeSetInstance_ID, C_Charge_ID, Description, VendorProductNo,
C_Order_ID, C_Invoice_ID, M_InOut_ID, M_RMA_ID, DateDoc, C_BPartner_ID, DocStatus, CreateFromType)
AS
--  From Order
