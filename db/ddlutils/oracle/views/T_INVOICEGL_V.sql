...
SELECT
    ...
    COALESCE(gl.C_Currency_ID , i.C_Currency_ID) AS C_Currency_ID,
...
--  Gain/Loss
    ...
    ((fa.AmtAcctDr-fa.AmtAcctCr)*gl.Percent/100) AS AmtAcctOpenBalance , gl.AD_Table_ID , gl.Record_ID , 'en_US' AS AD_Language
FROM T_InvoiceGL gl
