CREATE OR REPLACE FUNCTION monthlySalary
(
 ...
 *
 * Test:
 * 	SELECT monthlySalary (113) FROM DUAL; - Get monthly salary for GardenAdmin BP now
 * 	SELECT monthlySalary (113) FROM DUAL; - Get monthly salary for GardenAdmin BP now
 ************************************************************************/
RETURN NUMBER AS
BEGIN
	RETURN monthlySalaryToDate(p_C_BPartner_ID, SYSDATE);
END monthlySalary;