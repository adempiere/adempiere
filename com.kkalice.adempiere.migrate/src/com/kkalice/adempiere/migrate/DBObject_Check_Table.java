/*
 * Name:		DBObject_Check_Table.java
 * Description:	detailed definition for cheque constraint
 * Created:		Mar 1, 2009
 * Vendor:		K.K. Alice
 * Author:		Stefan Christians
 * 
 * FileTarget:	~/development/sandbox/migrate/src/com/kkalice/adempiere/migrate/DBObject_Check_Table.java
 * FileOwner:	spc.dvp
 * FilePerms:	0644
 *
 */
 ...
 * @author Stefan Christians
 */
public class DBObject_Check_Table extends DBObjectDefinition {

	/** table on which check constraint is defined */
	private String m_table = null;
	/** whether this check constraint is deferrable */
	private boolean m_isDeferrable = false;
	/** whether this check constraint is initially deferred */
	 ...
	 * @param sequence
	 */
	public DBObject_Check_Table(DBConnection parent, String name, int sequence) {
		super(parent, name, sequence);
	}

	/**
	 * initialize detailed definitions for check constraint
	 * @param tableName the table on which the check constraint is defined
