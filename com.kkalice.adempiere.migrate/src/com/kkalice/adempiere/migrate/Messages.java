...
public class Messages extends ListResourceBundle {
	...
	protected Object[][] getContents() {
		return new Object[][] {
				...
				{"guiMenuFileMnemonic", Integer.valueOf(KeyEvent.VK_F).toString()},
				{"guiMenuFileSaveMnemonic", Integer.valueOf(KeyEvent.VK_S).toString()},
				{"guiMenuFileCloseMnemonic", Integer.valueOf(KeyEvent.VK_C).toString()},
				{"guiMenuFileExitMnemonic", Integer.valueOf(KeyEvent.VK_Q).toString()},
				{"guiMenuHelpMnemonic", Integer.valueOf(KeyEvent.VK_H).toString()},
				{"guiMenuHelpInfoMnemonic", Integer.valueOf(KeyEvent.VK_H).toString()},
				{"guiMenuHelpAboutMnemonic", Integer.valueOf(KeyEvent.VK_A).toString()},
				...
				{"guiSourceResetMnemonic", Integer.valueOf(KeyEvent.VK_S).toString()},
				{"guiTargetResetMnemonic", Integer.valueOf(KeyEvent.VK_T).toString()},
				{"guiModeUpgradeMnemonic", Integer.valueOf(KeyEvent.VK_U).toString()},
				{"guiModeTransferMnemonic", Integer.valueOf(KeyEvent.VK_R).toString()},
				{"guiOptionLogLevelMnemonic", Integer.valueOf(KeyEvent.VK_G).toString()},
				{"guiOptionAttemptTranslationsMnemonic", Integer.valueOf(KeyEvent.VK_A).toString()},
				{"guiOptionPreserveTableIDsMnemonic", Integer.valueOf(KeyEvent.VK_C).toString()},
				{"guiOptionPreserveGardenWorldMnemonic", Integer.valueOf(KeyEvent.VK_Z).toString()},
				{"guiOptionTruncateTemporaryTablesMnemonic", Integer.valueOf(KeyEvent.VK_R).toString()},
				{"guiOptionPreserveUnreferencedElementsMnemonic", Integer.valueOf(KeyEvent.VK_P).toString()},
				{"guiOptionPreserveLogsMnemonic", Integer.valueOf(KeyEvent.VK_H).toString()},
				{"guiDaysMnemonic", Integer.valueOf(KeyEvent.VK_N).toString()},
				{"guiOptionDropSourceMnemonic", Integer.valueOf(KeyEvent.VK_D).toString()},
				{"guiOptionOptimizeDatabaseMnemonic", Integer.valueOf(KeyEvent.VK_O).toString()},
				{"guiButtonStartMnemonic", Integer.valueOf(KeyEvent.VK_M).toString()},
				{"guiButtonCancelMnemonic", Integer.valueOf(KeyEvent.VK_C).toString()},
				{"guiButtonCloseMnemonic", Integer.valueOf(KeyEvent.VK_L).toString()},
				{"guiButtonViewTraceMnemonic", Integer.valueOf(KeyEvent.VK_V).toString()},
				{"guiButtonViewWarningsMnemonic", Integer.valueOf(KeyEvent.VK_W).toString()},
				{"guiButtonViewErrorsMnemonic", Integer.valueOf(KeyEvent.VK_E).toString()},
