...
-- Warehouse Management
UPDATE AD_Menu SET Name='Generate Shipments base on Outbound Order',Updated=TO_DATE('2009-10-05 13:14:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Menu_ID=193
;
