...
-- Warehouse Management
INSERT INTO AD_Browse (AD_Browse_ID,AD_Client_ID,AD_Org_ID,AD_View_ID,Created,CreatedBy,Description,EntityType,IsActive,IsBetaFunctionality,Name,Processing,Updated,UpdatedBy,Value,WhereClause) VALUES (50001,0,0,50001,TO_DATE('2009-09-11 13:24:26','YYYY-MM-DD HH24:MI:SS'),0,'This Smart Browse allow select the Outbound Order to release the lines that need be pick.','EE03','Y','N','Outbound Order to Release','N',TO_DATE('2009-09-11 13:24:26','YYYY-MM-DD HH24:MI:SS'),0,'OutboundOrderToRelease','IsSOTrx=''Y'' AND DocStatus=''DR''')
;
