...
-- Warehouse Management
INSERT INTO AD_Browse (AD_Browse_ID,AD_Client_ID,AD_Org_ID,AD_View_ID,Created,CreatedBy,Description,EntityType,IsActive,IsBetaFunctionality,Name,Processing,Updated,UpdatedBy,Value,WhereClause) VALUES (50000,0,0,50000,TO_TIMESTAMP('2009-09-02 01:49:39','YYYY-MM-DD HH24:MI:SS'),0,'This Smatt Browse allow select the Sales order to generate an Outbound Order.','EE07','Y','Y','Salas Order to Picking','N',TO_TIMESTAMP('2009-09-02 01:49:39','YYYY-MM-DD HH24:MI:SS'),0,'SalesOrderToPicking','IsSOTrx=''Y'' AND DocStatus=''CO''')
;
