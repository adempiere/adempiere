...
public class X_AD_EntityJoinColumn extends PO implements I_AD_EntityJoinColumn, I_Persistent 
{
	...
	public org.eevolution.model.I_AD_EntityRelationship getAD_EntityRelationship() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.eevolution.model.I_AD_EntityRelationship.Table_Name);
        org.eevolution.model.I_AD_EntityRelationship result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.eevolution.model.I_AD_EntityRelationship)constructor.newInstance(new Object[] {getCtx(), new Integer(getAD_EntityRelationship_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
