...
/** Generated Model for M_InOutBound
 *  @author Adempiere (generated) 
 *  @version Release 3.5.3a - $Id$ */
public class X_M_InOutBound extends PO implements I_M_InOutBound, I_Persistent 
{
    ...
    public X_M_InOutBound (Properties ctx, int M_InOutBound_ID, String trxName)
    {
...
// 5
    ...
    /** Load Constructor */
    public X_M_InOutBound (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_InOutBound[")
