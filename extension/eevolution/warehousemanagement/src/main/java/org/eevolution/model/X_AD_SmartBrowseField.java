...
public class X_AD_SmartBrowseField extends PO implements I_AD_SmartBrowseField, I_Persistent 
{
    ...
    {
        Class<?> clazz = MTable.getClass(org.eevolution.model.I_AD_ViewColumn.Table_Name);
        org.eevolution.model.I_AD_ViewColumn result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.eevolution.model.I_AD_ViewColumn)constructor.newInstance(new Object[] {getCtx(), new Integer(getAD_ViewColumn_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
