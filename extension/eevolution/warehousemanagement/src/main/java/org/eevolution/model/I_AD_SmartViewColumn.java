...
/** Generated Interface for AD_SmartViewColumn
 *  @author Adempiere (generated) 
 *  @version Release 3.5.3a
 */
public interface I_AD_SmartViewColumn 
{

    /** TableName=AD_SmartViewColumn */
    public static final String Table_Name = "AD_SmartViewColumn";
    ...
    /** Column name AD_SmartViewColumn_ID */
    public static final String COLUMNNAME_AD_SmartViewColumn_ID = "AD_SmartViewColumn_ID";

	/** Set Smart View Column	  */
	public void setAD_SmartViewColumn_ID (int AD_SmartViewColumn_ID);

	/** Get Smart View Column	  */
	public int getAD_SmartViewColumn_ID();
