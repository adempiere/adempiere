...
public class X_AD_SmartBrowse_Access extends PO implements I_AD_SmartBrowse_Access, I_Persistent 
{
	...
	public org.eevolution.model.I_AD_SmartBrowse getAD_SmartBrowse() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.eevolution.model.I_AD_SmartBrowse.Table_Name);
        org.eevolution.model.I_AD_SmartBrowse result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.eevolution.model.I_AD_SmartBrowse)constructor.newInstance(new Object[] {getCtx(), new Integer(getAD_SmartBrowse_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
