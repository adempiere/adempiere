 ...
 */
public class Telegram implements INotification {
	...
	public void setAppRegistrationId(int registrationId) {
		...
		botName = registration.getParameterValue(BOT_NAME);
		botToken = registration.getParameterValue(BOT_TOKEN);
		chatId = registration.getParameterValue(CHAT_ID);
	...
	public static void main(String[] args) {
		...
		Trx.run(transactionName -> {
			...
			notifier
				.clearMessage()
				.withApplicationType(DefaultNotifier.DefaultNotificationType_Telegram)
				.withUserId(100)
