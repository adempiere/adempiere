...
public abstract class ImportPayrollMovementsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "Import_PayrollMovements";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Import Payroll Movements";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 53197;
