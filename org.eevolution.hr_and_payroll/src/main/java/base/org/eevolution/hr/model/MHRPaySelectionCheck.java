...
import org.adempiere.core.domains.models.I_HR_PaySelectionLine;
...
public class MHRPaySelectionCheck extends X_HR_PaySelectionCheck
{
	...
	public MHRPaySelectionCheck(MHRPaySelectionLine line, String PaymentRule)
	{
		...
		MHRMovement movement  = new MHRMovement(getCtx(), line.getHR_Movement_ID(), get_TrxName());
		setAD_Org_ID(movement.getAD_Org_ID());
	...
	{
		MHRMovement movement = new MHRMovement(getCtx(), line.getHR_Movement_ID(), line.get_TrxName());
		if (getC_BPartner_ID() != movement.getC_BPartner_ID()) {
