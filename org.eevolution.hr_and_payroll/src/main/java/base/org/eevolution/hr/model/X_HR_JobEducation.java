...
import org.adempiere.core.api.I_HR_JobEducation;
import org.compiere.model.*;
import org.compiere.util.KeyNamePair;

/** Generated Model for HR_JobEducation
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_HR_JobEducation extends PO implements I_HR_JobEducation, I_Persistent 
{
    ...
    public X_HR_JobEducation (Properties ctx, int HR_JobEducation_ID, String trxName)
    {
      ...
      /** if (HR_JobEducation_ID == 0)
        {
			setHR_JobEducation_ID (0);
			setName (null);
        } */
    }

    /** Load Constructor */
    public X_HR_JobEducation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_JobEducation[")
