...
import org.adempiere.core.api.I_HR_Concept_Type;
import org.compiere.model.*;
import org.compiere.util.KeyNamePair;

/** Generated Model for HR_Concept_Type
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_HR_Concept_Type extends PO implements I_HR_Concept_Type, I_Persistent 
{
    ...
    public X_HR_Concept_Type (Properties ctx, int HR_Concept_Type_ID, String trxName)
    {
      ...
      /** if (HR_Concept_Type_ID == 0)
        {
			setHR_Concept_Type_ID (0);
        } */
    }

    /** Load Constructor */
    public X_HR_Concept_Type (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Concept_Type[")
