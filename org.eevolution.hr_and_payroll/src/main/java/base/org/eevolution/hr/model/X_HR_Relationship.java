...
import org.adempiere.core.api.I_HR_Relationship;
import org.compiere.model.*;
import org.compiere.util.KeyNamePair;

/** Generated Model for HR_Relationship
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_HR_Relationship extends PO implements I_HR_Relationship, I_Persistent 
{
    ...
    public X_HR_Relationship (Properties ctx, int HR_Relationship_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_HR_Relationship (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Relationship[")
	...
	public void setHR_Relationship_ID (int HR_Relationship_ID)
	{
		if (HR_Relationship_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Relationship_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Relationship_ID, Integer.valueOf(HR_Relationship_ID));
	}
