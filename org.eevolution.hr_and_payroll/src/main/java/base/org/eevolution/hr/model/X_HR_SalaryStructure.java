...
import org.adempiere.core.api.I_HR_SalaryStructure;
import org.compiere.model.*;
import org.compiere.util.KeyNamePair;

/** Generated Model for HR_SalaryStructure
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_HR_SalaryStructure extends PO implements I_HR_SalaryStructure, I_Persistent 
{
    ...
    public X_HR_SalaryStructure (Properties ctx, int HR_SalaryStructure_ID, String trxName)
    {
      super (ctx, HR_SalaryStructure_ID, trxName);
      /** if (HR_SalaryStructure_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_HR_SalaryStructure (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_SalaryStructure[")
