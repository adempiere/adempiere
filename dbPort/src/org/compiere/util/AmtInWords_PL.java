...
public class AmtInWords_PL implements AmtInWords {
	...
	/** Ten to Ninety */
	private static final String[] tensNames = { "", "dziesiêæ", "dwadzieœcia",
			"trzydzieœci", "czterdzieœci", "piêædziesi¹t", "szeœædziesi¹t",
			"siedemdziesi¹t", "osiemdziesi¹t", "dziewiêædziesi¹t" };

	private static final String[] hundredNames = { "", "sto", "dwieœcie",
			"trzysta", "czterysta", "piêæset", "szeœæset", "siedemset",
			"osiemset", "dziewiêæset" };

	/** numbers to 19 */
	private static final String[] numNames = { "", "jeden", "dwa", "trzy",
			"cztery", "piêæ", "szeœæ", "siedem", "osiem", "dzieiwiêæ",
			"dziesiêæ", "jedenaœcie", "dwanaœcie", "trzynaœcie", "czternaœcie",
			"pietnaœcie", "szescnaœcie", "siedemnaœcie", "osiemnaœcie",
			"dziewiêtnaœcie" };
