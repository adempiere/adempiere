 ...
 *  @version Release 2.5.3d - 2006-10-10 21:55:55.656 */
...
protected static KeyNamePair Model = new KeyNamePair(866,"CM_CStage");
...
{
StringBuffer sb = new StringBuffer ("X_CM_CStage[").append(get_ID()).append("]");
return sb.toString();
}
...
set_Value ("CM_CStageLink_ID", new Integer(CM_CStageLink_ID));
}
/** Get Container Link.
@return Stage Link to another Container in the Web Project */
public int getCM_CStageLink_ID() 
{
Integer ii = (Integer)get_Value("CM_CStageLink_ID");
if (ii == null) return 0;
return ii.intValue();
}
...
set_Value ("CM_Template_ID", new Integer(CM_Template_ID));
}
/** Get Template.
...
{
set_ValueNoCheck ("IsModified", new Boolean(IsModified));
}
/** Get Modified.
...
{
if (RelativeURL == null) throw new IllegalArgumentException ("RelativeURL is mandatory.");
