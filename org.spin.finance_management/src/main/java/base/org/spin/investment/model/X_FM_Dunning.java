...
/** Generated Model for FM_Dunning
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_FM_Dunning extends PO implements I_FM_Dunning, I_Persistent 
{
    ...
    {
      super (ctx, FM_Dunning_ID, trxName);
      /** if (FM_Dunning_ID == 0)
        {
			setFM_Dunning_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_FM_Dunning (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FM_Dunning[")
