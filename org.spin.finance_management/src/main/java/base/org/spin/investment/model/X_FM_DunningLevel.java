...
public class X_FM_DunningLevel extends PO implements I_FM_DunningLevel, I_Persistent 
{
    ...
    {
		return (org.spin.investment.model.I_FM_Dunning)MTable.get(getCtx(), org.spin.investment.model.I_FM_Dunning.Table_Name)
    ...
    {
		return (org.spin.investment.model.I_FM_Rate)MTable.get(getCtx(), org.spin.investment.model.I_FM_Rate.Table_Name)
	...
	public org.spin.investment.model.I_FM_StatusType getFM_StatusType() throws RuntimeException
    {
		return (org.spin.investment.model.I_FM_StatusType)MTable.get(getCtx(), org.spin.investment.model.I_FM_StatusType.Table_Name)
