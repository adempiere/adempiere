...
/** Generated Process for (Import Financial Agreement)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.0
 */
public abstract class ImportAgreementAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "Import Agreement";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Import Financial Agreement";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54072;
