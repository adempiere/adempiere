...
-- POS Integration
UPDATE AD_Element_Trl SET Name='Tipo Doc. Venta al por mayor',PrintName='Tipo Doc. Venta al por mayor',Updated=TO_DATE('2015-08-21 09:42:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000013 AND AD_Language='es_MX'
;

-- Aug 21, 2015 9:43:14 AM VET
-- POS Integration
UPDATE AD_Element SET Name='Doc Type Wholesale', PrintName='Doc Type Wholesale',Updated=TO_DATE('2015-08-21 09:43:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000013
;
...
-- Aug 21, 2015 9:43:14 AM VET
-- POS Integration
UPDATE AD_PrintFormatItem pi SET PrintName='Doc Type Wholesale', Name='Doc Type Wholesale' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1000013)
;

-- Aug 21, 2015 9:43:42 AM VET
-- POS Integration
UPDATE AD_Element_Trl SET Name='Lista de Precio Venta al por mayor',PrintName='Lista de Precio Venta al por mayor',Updated=TO_DATE('2015-08-21 09:43:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000012 AND AD_Language='es_MX'
;

-- Aug 21, 2015 9:44:03 AM VET
-- POS Integration
UPDATE AD_Element SET Name='Price List Wholesale', PrintName='Price List Wholesale',Updated=TO_DATE('2015-08-21 09:44:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000012
;
...
-- Aug 21, 2015 9:44:03 AM VET
-- POS Integration
UPDATE AD_PrintFormatItem pi SET PrintName='Price List Wholesale', Name='Price List Wholesale' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1000012)
;
