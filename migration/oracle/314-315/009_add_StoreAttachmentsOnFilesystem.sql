...
ALTER TABLE ad_client ADD StoreAttachmentsOnFilesystem CHAR(1 BYTE) DEFAULT 'N' NOT NULL;
ALTER TABLE ad_client ADD WindowsAttachmentPath NVARCHAR2(255);
ALTER TABLE ad_client ADD UnixAttachmentPath NVARCHAR2(255);
