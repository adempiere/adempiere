...
-- Add M_InOutLine_ID Landed Cost Allocation
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,59611,61144,0,698,TO_DATE('2011-02-07 12:22:41','YYYY-MM-DD HH24:MI:SS'),0,'The record is active in the system',1,'D','There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports.
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','Y','Y','Y','N','N','N','N','N','Active',TO_DATE('2011-02-07 12:22:41','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Add M_InOutLine_ID Landed Cost Allocation
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,60320,61145,0,698,TO_DATE('2011-02-07 12:24:46','YYYY-MM-DD HH24:MI:SS'),0,'Line on Shipment or Receipt document',10,'D','The Shipment/Receipt Line indicates a unique line in a Shipment/Receipt document','Y','Y','Y','N','N','N','N','N','Shipment/Receipt Line',TO_DATE('2011-02-07 12:24:46','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Add M_InOutLine_ID Landed Cost Allocation
UPDATE AD_Field SET IsReadOnly='Y', IsSameLine='Y',Updated=TO_DATE('2011-02-07 12:29:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=61145
;
