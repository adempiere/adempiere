...
-- Cost Engine
ALTER TABLE M_CostDetail ADD IsReversal CHAR(1) DEFAULT 'N' CHECK (IsReversal IN ('Y','N'))
;

-- Sep 7, 2010 6:53:42 PM CDT
-- Cost Engine
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,59788,59632,0,748,TO_DATE('2010-09-07 18:53:40','YYYY-MM-DD HH24:MI:SS'),100,'This is a reversing transaction',1,'D','The Reversal check box indicates if this is a reversal of a prior transaction.','Y','Y','Y','N','N','N','N','N','Reversal',TO_DATE('2010-09-07 18:53:40','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Cost Engine
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2010-09-07 19:00:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=59632
;
