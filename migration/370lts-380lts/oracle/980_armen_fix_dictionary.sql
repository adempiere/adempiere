...
-- 12 Mar 13 17:14:24
-- Not use Asset Type
UPDATE AD_Column SET IsSelectionColumn='N',Updated=TO_DATE('2013-03-12 17:14:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59259
;

-- 11 Mar 13 14:41:25
-- A_Asset_Disposed.AD_Org_ID
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_DATE('2013-03-11 14:41:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=59135
;

-- 11 Mar 13 14:41:48
-- A_Asset_Disposed.AD_Org_ID
UPDATE AD_Column SET IsUpdateable='Y',Updated=TO_DATE('2013-03-11 14:41:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=55656
;

-- 23 Mar 13 20:48:59
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Tab SET IsInsertRecord='N',Updated=TO_DATE('2013-03-23 20:48:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Tab_ID=53162
;

-- Mar 5, 2014 9:24:30 AM WIT
-- DICTIONARY_ID_COMMENTS
INSERT INTO AD_Val_Rule (Code,Type,EntityType,Name,AD_Val_Rule_ID,CreatedBy,Updated,UpdatedBy,AD_Org_ID,AD_Client_ID,IsActive,Created) VALUES ('A_Asset_Status IN (''NW'',''AC'')','S','D','Asset - new and activated',26001,0,TO_DATE('2014-03-05 09:24:29','YYYY-MM-DD HH24:MI:SS'),0,0,0,'Y',TO_DATE('2014-03-05 09:24:29','YYYY-MM-DD HH24:MI:SS'))
;

-- Mar 5, 2014 9:26:27 AM WIT
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Column SET AD_Val_Rule_ID=26001,Updated=TO_DATE('2014-03-05 09:26:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=55954
;

-- Jan 10, 2014 4:51:57 PM WIT
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Column SET AD_Val_Rule_ID=NULL,Updated=TO_DATE('2014-01-10 16:51:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=8051
;

-- 06 Mar 13 17:14:53
-- BF: Database Error.: ERROR: null value in column "isapproved" violates not-null constraint
UPDATE AD_Column SET DefaultValue='N', Updated=TO_DATE('2013-03-06 17:14:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59482
;
...
-- 06 Mar 13 17:43:54
UPDATE AD_Column SET ColumnSQL=NULL, DefaultValue='''N''', Updated=TO_DATE('2013-03-06 17:43:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59319
;
...
-- 06 Mar 13 17:42:19
UPDATE AD_Column SET ColumnSQL=NULL, DefaultValue='''N''', Updated=TO_DATE('2013-03-06 17:42:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59320
;
...
--BF: "ERROR: null value in column "uselifemonths" violates not-null constraint
UPDATE AD_Column SET IsMandatory='N', Updated=TO_DATE('2013-03-29 13:07:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=59517
;
