...
-- Warehouse Management Functionality
UPDATE AD_Browse SET WhereClause='NOT EXISTS (SELECT 1 FROM M_InOutLine WHERE M_InOutLine.C_OrderLine_ID = iobl.C_OrderLine_ID AND iobl.PickedQty >= M_InOutLine.MovementQty)  AND iob.IsSOTrx=''Y'' AND iobl.Processed=''Y'' AND ol.QtyOrdered <> ol.QtyDelivered',Updated=TO_TIMESTAMP('2009-10-06 17:53:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Browse_ID=50002
;

-- Oct 6, 2009 6:16:18 PM CDT
-- Warehouse Management Functionality
UPDATE AD_View_Column SET ColumnSQL='ol.QtyOrdered-ol.QtyDelivered',Updated=TO_TIMESTAMP('2009-10-06 18:16:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_View_Column_ID=50605
;