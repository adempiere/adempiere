...
-- Cost Engine
UPDATE AD_Val_Rule SET Code='M_CostElement.CostElementType=''L''',Updated=TO_DATE('2010-10-13 19:02:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=222
;
