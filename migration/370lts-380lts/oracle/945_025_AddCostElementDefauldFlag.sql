...
-- Cost Engine
ALTER TABLE M_CostElement ADD IsDefault CHAR(1) DEFAULT NULL  CHECK (IsDefault IN ('Y','N'))
;

-- Oct 7, 2010 11:31:27 PM CDT
-- Cost Engine
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,59917,59686,0,699,TO_DATE('2010-10-07 23:31:24','YYYY-MM-DD HH24:MI:SS'),100,'Default value',1,'D','The Default Checkbox indicates if this record will be used as a default value.','Y','Y','Y','N','N','N','N','N','Default',TO_DATE('2010-10-07 23:31:24','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Cost Engine
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2010-10-07 23:31:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11290
;
...
-- Cost Engine
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2010-10-07 23:34:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11290
;

-- Oct 7, 2010 11:34:44 PM CDT
-- Cost Engine
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2010-10-07 23:34:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=59686
;
