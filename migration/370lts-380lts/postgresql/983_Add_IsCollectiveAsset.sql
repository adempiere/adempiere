...
UPDATE AD_Field SET IsDisplayed='N', Updated=TO_TIMESTAMP('2014-04-05 03:37:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=59082
;

-- Apr 5, 2014 3:39:57 AM WIT
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Column SET AD_Val_Rule_ID=200035,Updated=TO_TIMESTAMP('2014-04-05 03:39:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=26301
;

-- Apr 5, 2014 3:45:35 AM WIT
-- DICTIONARY_ID_COMMENTS
INSERT INTO AD_Element (PrintName,EntityType,ColumnName,Name,Description,AD_Element_ID,AD_Client_ID,Created,Updated,IsActive,UpdatedBy,CreatedBy,AD_Org_ID,Help) VALUES ('Collective Asset','D','IsCollectiveAsset','IsCollectiveAsset','Asset Quantity is Collective',26023,0,TO_TIMESTAMP('2014-04-05 03:45:35','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2014-04-05 03:45:35','YYYY-MM-DD HH24:MI:SS'),'Y',0,0,0,'Asset Quantity is Collective')
;
...
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Field SET DisplayLogic='@A_CreateAsset@=''Y''&@A_CapvsExp@=''Cap''', IsSameLine='Y',Updated=TO_TIMESTAMP('2014-04-05 03:56:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=26002
;

-- Apr 5, 2014 3:58:10 AM WIT
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Element SET Name='Collective Asset',Updated=TO_TIMESTAMP('2014-04-05 03:58:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=26023
;
...
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Field_Trl SET Name='Collective Asset',Updated=TO_TIMESTAMP('2014-04-05 04:00:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=26002 AND AD_Language='in_ID'
;
...
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2014-04-05 04:04:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=26000
;

-- Apr 7, 2014 9:40:32 AM WIT
-- DICTIONARY_ID_COMMENTS
UPDATE AD_Column SET DefaultValue='''N''',Updated=TO_TIMESTAMP('2014-04-07 09:40:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=26303
;

-- Index: a_asset
-- DROP INDEX a_asset_value;
CREATE UNIQUE INDEX a_asset_value
ON a_asset
USING btree
