...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,55507,0,18,251,'Axis_Column_ID',TO_TIMESTAMP('2012-06-27 11:28:39','YYYY-MM-DD HH24:MI:SS'),100,'Axis the link column.','EE07',22,'Axis Column defines the base column to show the records on this table as columns inside the browser','Y','Axis Column','Axis Column',TO_TIMESTAMP('2012-06-27 11:28:39','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Reference (AD_Client_ID,AD_Org_ID,AD_Reference_ID,Created,CreatedBy,Description,EntityType,IsActive,IsOrderByValue,Name,Updated,UpdatedBy,ValidationType) VALUES (0,0,53437,TO_TIMESTAMP('2012-06-27 11:30:43','YYYY-MM-DD HH24:MI:SS'),100,'View Column selection','EE07','Y','N','AD_View_Column',TO_TIMESTAMP('2012-06-27 11:30:43','YYYY-MM-DD HH24:MI:SS'),100,'T')
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Ref_Table (AD_Client_ID,AD_Display,AD_Key,AD_Org_ID,AD_Reference_ID,AD_Table_ID,Created,CreatedBy,EntityType,IsActive,IsValueDisplayed,Updated,UpdatedBy) VALUES (0,58106,58100,0,53437,53232,TO_TIMESTAMP('2012-06-27 11:31:12','YYYY-MM-DD HH24:MI:SS'),100,'EE07','Y','N',TO_TIMESTAMP('2012-06-27 11:31:12','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jun 27, 2012 11:31:48 AM CDT
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,55508,0,18,53437,'Axis_Parent_Column_ID',TO_TIMESTAMP('2012-06-27 11:31:27','YYYY-MM-DD HH24:MI:SS'),100,'The link Axis column view on the parent key','EE07',22,'Axis Parent Column filters the records used by Axis Column, the values for the filter are obtained from the context of the Field Browser defined as query criteria
context.','Y','Axis Parent Column','Axis Parent Column',TO_TIMESTAMP('2012-06-27 11:31:27','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,63218,55507,0,18,251,53223,'Axis_Column_ID',TO_TIMESTAMP('2012-06-27 11:35:07','YYYY-MM-DD HH24:MI:SS'),100,'Axis the link column.','EE07',22,'Axis Column defines the base column to show the records on this table as columns inside the browser','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Axis Column',0,TO_TIMESTAMP('2012-06-27 11:35:07','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
ALTER TABLE AD_Browse_Field ADD COLUMN Axis_Column_ID NUMERIC(10) DEFAULT NULL 
;

-- Jun 27, 2012 11:35:35 AM CDT
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,63219,55508,0,18,53437,53223,'Axis_Parent_Column_ID',TO_TIMESTAMP('2012-06-27 11:35:31','YYYY-MM-DD HH24:MI:SS'),100,'The link Axis column view on the parent key','EE07',22,'Axis Parent Column filters the records used by Axis Column, the values for the filter are obtained from the context of the Field Browser defined as query criteria
context.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Axis Parent Column',0,TO_TIMESTAMP('2012-06-27 11:35:31','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
ALTER TABLE AD_Browse_Field ADD COLUMN Axis_Parent_Column_ID NUMERIC(10) DEFAULT NULL 
;

-- Jun 27, 2012 11:37:07 AM CDT
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,63218,64393,0,53247,TO_TIMESTAMP('2012-06-27 11:36:22','YYYY-MM-DD HH24:MI:SS'),100,'Axis the link column.',22,'EE07','Axis Column defines the base column to show the records on this table as columns inside the browser','Y','Y','Y','N','N','N','N','N','Axis Column',TO_TIMESTAMP('2012-06-27 11:36:22','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,63219,64394,0,53247,TO_TIMESTAMP('2012-06-27 11:37:07','YYYY-MM-DD HH24:MI:SS'),100,'The link Axis column view on the parent key',22,'EE07','Axis Parent Column filters the records used by Axis Column, the values for the filter are obtained from the context of the Field Browser defined as query criteria
context.','Y','Y','Y','N','N','N','N','N','Axis Parent Column',TO_TIMESTAMP('2012-06-27 11:37:07','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
UPDATE AD_Field SET DisplayLogic='@AD_Reference_ID@=18 | @AD_Reference_ID@=17 | @AD_Reference_ID@=19  | @AD_Reference_ID@=20',Updated=TO_TIMESTAMP('2012-06-27 11:38:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=64393
;

-- Jun 27, 2012 11:39:00 AM CDT
-- https://adempiere.atlassian.net/browse/ADEMPIERE-128 New feature lets you define a field as column axis
UPDATE AD_Field SET DisplayLogic='@Axis_Column_ID@ ! 0',Updated=TO_TIMESTAMP('2012-06-27 11:39:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=64394
;
