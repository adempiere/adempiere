...
-- Aug 28, 2010 5:46:41 PM CDT
-- Cost Engine
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Column t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Column_ID=59705 AND NOT EXISTS (SELECT * FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- Aug 28, 2010 5:46:54 PM CDT
-- Cost Engine
UPDATE AD_Column SET MandatoryLogic=NULL,Updated=TO_TIMESTAMP('2010-08-28 17:46:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59153
;

-- Aug 28, 2010 5:47:07 PM CDT
-- Cost Engine
DELETE FROM AD_Column_Trl WHERE AD_Column_ID=59705
;

-- Aug 28, 2010 5:47:07 PM CDT
-- Cost Engine
DELETE FROM AD_Column WHERE AD_Column_ID=59705
;

-- Aug 28, 2010 5:47:45 PM CDT
-- Cost Engine
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,59706,2962,0,37,808,'CostAmt',TO_TIMESTAMP('2010-08-28 17:47:45','YYYY-MM-DD HH24:MI:SS'),0,'Value with Cost','D',22,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Cost Value',0,TO_TIMESTAMP('2010-08-28 17:47:45','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Cost Engine
ALTER TABLE M_CostDetail ADD COLUMN CostAmt NUMERIC DEFAULT NULL 
;

-- Aug 28, 2010 5:49:10 PM CDT
-- Cost Engine
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,59706,59622,0,748,TO_TIMESTAMP('2010-08-28 17:49:09','YYYY-MM-DD HH24:MI:SS'),0,'Value with Cost',22,'D','Y','Y','Y','N','N','N','N','N','Cost Value',TO_TIMESTAMP('2010-08-28 17:49:09','YYYY-MM-DD HH24:MI:SS'),0)
;
