...
UPDATE AD_Message_Trl SET IsTranslated='Y',Updated=TO_DATE('2011-07-04 12:21:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=53136 AND AD_Language LIKE 'es_%'
;
