...
-- 'Delete Entities' Form into ADempiere380
INSERT INTO AD_Menu (Action,AD_Client_ID,AD_Form_ID,AD_Menu_ID,AD_Org_ID,Created,CreatedBy,EntityType,IsActive,IsCentrallyMaintained,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('X',0,53039,53671,0,TO_DATE('2013-10-25 19:28:19','YYYY-MM-DD HH24:MI:SS'),0,'D','Y','Y','N','N','N','Delete Entities',TO_DATE('2013-10-25 19:28:19','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Oct 25, 2013 7:28:19 PM IST
-- 'Delete Entities' Form into ADempiere380
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID,AD_Tree_ID,Created,CreatedBy,IsActive,Node_ID,Parent_ID,SeqNo,Updated,UpdatedBy) VALUES (0,0,10,TO_DATE('2013-10-25 19:28:19','YYYY-MM-DD HH24:MI:SS'),0,'Y',53671,0,999,TO_DATE('2013-10-25 19:28:19','YYYY-MM-DD HH24:MI:SS'),0)
;
