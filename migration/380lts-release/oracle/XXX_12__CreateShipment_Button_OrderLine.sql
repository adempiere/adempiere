...
-- Create Shipment Process is Created
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsRange,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,69034,1490,0,53501,28,260,'CreateFrom',TO_DATE('2013-10-19 17:36:40','YYYY-MM-DD HH24:MI:SS'),0,'Process which will generate a new document lines based on an existing document','D',1,'The Create From process will create a new document based on information in an existing document selected by the user.','Y','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Create lines from',0,TO_DATE('2013-10-19 17:36:40','YYYY-MM-DD HH24:MI:SS'),0,0)
;
