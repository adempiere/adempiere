...
VALUES (0,58110,145,0,17,5,53224,'AccessLevel',TO_TIMESTAMP('2009-09-04 00:16:30','YYYY-MM-DD HH24:MI:SS'),0,'Access Level required','EE07',1,
'Indicates the access level required for this record or process.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Data Access Level',0,
TO_TIMESTAMP('2009-09-04 00:16:30','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Warehouse Management
ALTER TABLE AD_Browse ADD COLUMN AccessLevel CHAR(1) DEFAULT NULL 
;

-- Sep 4, 2009 12:17:33 AM ECT
-- Warehouse Management
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,
IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,58110,57530,0,53248,TO_TIMESTAMP('2009-09-04 00:17:26','YYYY-MM-DD HH24:MI:SS'),0,'Access Level required',1,'EE07',
'Indicates the access level required for this record or process.','Y','Y','Y','N','N','N','N','N','Data Access Level',TO_TIMESTAMP('2009-09-04 00:17:26','YYYY-MM-DD HH24:MI:SS'),0)
;
...
SELECT l.AD_Language,t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Field t 
WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Field_ID=57530 AND EXISTS (SELECT * FROM AD_Field_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Field_ID!=t.AD_Field_ID)
;
