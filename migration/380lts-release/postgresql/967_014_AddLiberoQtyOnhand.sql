...
UPDATE AD_Browse SET WhereClause='iob.IsSOTrx=''Y'' AND iob.DocStatus=''DR'' AND iobl.Processed=''N''',Updated=TO_TIMESTAMP('2009-10-05 12:35:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Browse_ID=50001
;

-- Oct 5, 2009 12:36:04 PM ECT
-- Warehouse Management
UPDATE AD_Browse SET WhereClause='NOT EXISTS (SELECT 1 FROM M_InOutLine WHERE M_InOutLine.C_OrderLine_ID = iobl.C_OrderLine_ID AND iobl.PickedQty >= M_InOutLine.MovementQty)  AND iob.IsSOTrx=''Y'' AND iobl.Processed=''Y''',Updated=TO_TIMESTAMP('2009-10-05 12:36:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Browse_ID=50002
;
...
-- Warehouse Management
UPDATE AD_Browse_Field SET Help=NULL,Updated=TO_TIMESTAMP('2009-10-05 13:05:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Browse_Field_ID=50344
;
...
-- Warehouse Management
INSERT INTO AD_Browse_Field (AD_Browse_Field_ID,AD_Browse_ID,AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_View_Column_ID,Created,CreatedBy,Description,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsIdentifier,IsKey,IsMandatory,IsQueryCriteria,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (50803,50001,0,530,0,29,50604,TO_TIMESTAMP('2009-10-05 13:06:43','YYYY-MM-DD HH24:MI:SS'),0,'On Hand Quantity','EE03','The On Hand Quantity indicates the quantity of a product that is on hand in a warehouse.','Y','Y','Y','N','N','N','N','N','QtyOnHand',65,TO_TIMESTAMP('2009-10-05 13:06:43','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Warehouse Management
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2009-10-05 13:12:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=57558
;

-- Oct 5, 2009 1:13:44 PM ECT
-- Warehouse Management
UPDATE AD_Menu SET Name='Release Outbound Order',Updated=TO_TIMESTAMP('2009-10-05 13:13:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Menu_ID=53232
;
...
-- Warehouse Management
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2009-10-05 13:17:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=57554
;

-- Oct 5, 2009 1:17:39 PM ECT
-- Warehouse Management
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2009-10-05 13:17:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=57555
;
