...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,55778,0,'ToBeInvoiced',TO_DATE('2012-12-18 19:08:07','YYYY-MM-DD HH24:MI:SS'),100,'If Shipment line is marked as ToBeInvoiced=''N'' then it is included in the generated Invoice line with price 0.0','U','Y','To be Invoiced','To be Invoiced',TO_DATE('2012-12-18 19:08:07','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Generate Invoices from Shipments
ALTER TABLE M_InOutLine ADD ToBeInvoiced CHAR(1) DEFAULT 'Y' CHECK (ToBeInvoiced IN ('Y','N'))
;
