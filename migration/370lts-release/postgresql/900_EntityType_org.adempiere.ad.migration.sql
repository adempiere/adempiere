...
INSERT INTO AD_EntityType (AD_Client_ID,AD_EntityType_ID,AD_Org_ID,Created,CreatedBy,Description,EntityType,Help,IsActive,ModelPackage,Name,Processing,Updated,UpdatedBy) VALUES (0,50020,0,TO_TIMESTAMP('2013-06-17 16:59:50','YYYY-MM-DD HH24:MI:SS'),100,'Adempiere XML Migration module','org.adempiere.ad.migration','See http://www.adempiere.com/AD_Migration','Y','org.adempiere.ad.migration.model','org.adempiere.ad.migration','N',TO_TIMESTAMP('2013-06-17 16:59:50','YYYY-MM-DD HH24:MI:SS'),100)
;
