...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (FieldLength,AD_Process_Para_ID,ColumnName,Help,AD_Process_ID,IsCentrallyMaintained,IsRange,Name,AD_Reference_ID,SeqNo,IsMandatory,AD_Element_ID,EntityType,AD_Client_ID,Created,AD_Org_ID,CreatedBy,IsActive,Description,Updated,UpdatedBy) VALUES (0,53911,'AD_Migration_ID','Migration change management.',53389,'Y','N','Migration',19,10,'Y',53877,'org.adempiere.ad.migration',0,TO_TIMESTAMP('2013-06-19 15:18:11','YYYY-MM-DD HH24:MI:SS'),0,100,'Y','Migration change management.',TO_TIMESTAMP('2013-06-19 15:18:11','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element (AD_Element_ID,Name,ColumnName,PrintName,AD_Reference_ID,FieldLength,EntityType,AD_Client_ID,Created,AD_Org_ID,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (55917,'Merge To','IsMergeTo','Merge To',20,1,'org.adempiere.ad.migration',0,TO_TIMESTAMP('2013-06-19 15:33:06','YYYY-MM-DD HH24:MI:SS'),0,100,'Y',TO_TIMESTAMP('2013-06-19 15:33:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (FieldLength,AD_Process_Para_ID,ColumnName,AD_Process_ID,IsCentrallyMaintained,IsRange,Name,AD_Reference_ID,DefaultValue,SeqNo,IsMandatory,AD_Element_ID,EntityType,AD_Client_ID,Created,AD_Org_ID,CreatedBy,IsActive,Description,Updated,UpdatedBy) VALUES (1,53913,'DeleteOld',53389,'N','N','Delete source migration',20,'Y',30,'Y',1669,'org.adempiere.ad.migration',0,TO_TIMESTAMP('2013-06-19 15:39:22','YYYY-MM-DD HH24:MI:SS'),0,100,'Y',NULL,TO_TIMESTAMP('2013-06-19 15:39:22','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process (Name,Statistic_Seconds,Classname,Help,AD_Process_ID,IsReport,AccessLevel,IsDirectPrint,Statistic_Count,Value,IsBetaFunctionality,ShowHelp,IsServerProcess,CopyFromProcess,EntityType,AD_Client_ID,Updated,Created,AD_Org_ID,CreatedBy,IsActive,UpdatedBy) VALUES ('Sort migration steps',0,'org.adempiere.ad.migration.process.MigrationSortSteps','By default, this process is sorting steps by Created',53390,'N','7','N',0,'AD_Migration_SortSteps','N','Y','N','N','org.adempiere.ad.migration',0,TO_TIMESTAMP('2013-06-19 15:47:53','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-06-19 15:47:53','YYYY-MM-DD HH24:MI:SS'),0,100,'Y',100)
;
