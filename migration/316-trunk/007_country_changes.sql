...
INSERT INTO C_COUNTRY
	...
	VALUES (349, 0, 0, 'Y', TO_DATE('2003-03-09', 'YYYY-MM-DD'), 0, TO_DATE('2000-01-02','YYYY-MM-DD'), 0,
...
INSERT INTO C_COUNTRY
		...
		NAME, DESCRIPTION, COUNTRYCODE, HASREGION, DISPLAYSEQUENCE, HASPOSTAL_ADD, C_CURRENCY_ID,
		ISADDRESSLINESREVERSE, ISADDRESSLINESLOCALREVERSE)
	VALUES (350, 0, 0, 'Y', TO_DATE('2003-03-09','YYYY-MM-DD'), 0, TO_DATE('2000-01-02','YYYY-MM-DD'), 0,
...
INSERT INTO C_CURRENCY
		...
		VALUES(347, 0, 0, 'Y', TO_DATE('2003-08-06','YYYY-MM-DD'),0, TO_DATE('2000-01-02','YYYY-MM-DD), 0, 'RSD',
