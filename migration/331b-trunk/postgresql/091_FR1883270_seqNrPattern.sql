...
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000001,'DecimalPattern',TO_TIMESTAMP('2008-02-05 16:30:43','YYYY-MM-DD HH24:MI:SS'),100,'Java Decimal Pattern','D','Option Decimal pattern in Java notation. Example: pattern 0000 will format the sequence number 23 to 0023','Y','Decimal Pattern','Decimal Pattern',TO_TIMESTAMP('2008-02-05 16:30:43','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- [ 1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET Name='decimal Pattern',Updated=TO_TIMESTAMP('2008-02-05 16:49:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;
...
-- [ 1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET Name='Decimal Pattern',Updated=TO_TIMESTAMP('2008-02-05 16:50:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;
...
-- [ 1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET Name='Pattern',Updated=TO_TIMESTAMP('2008-02-05 16:51:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;
...
-- [ 1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET DisplayLength=14,Updated=TO_TIMESTAMP('2008-02-05 16:52:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;

-- 07.02.2008 13:25:39 CET
-- [ 1883270 ] Enhance Document No Formatting
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2008-02-07 13:25:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;
