...
-- 15/02/2008 15h50min37s PYST
-- [FR 1834749 ] Control applied migration scripts
INSERT INTO AD_Process (AD_Org_ID,AD_Process_ID,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value,AccessLevel,AD_Client_ID) VALUES (0,53070,'org.compiere.process.PrepareMigrationScripts',TO_DATE('2008-02-15 15:50:36','YYYY-MM-DD HH24:MI:SS'),100,'A','Y','N','N','N','N','Prepare Migration Scripts','Y',0,0,TO_DATE('2008-02-15 15:50:36','YYYY-MM-DD HH24:MI:SS'),100,'PrepareMigrationScripts','4',0)
;
...
-- 15/02/2008 17h46min21s PYST
-- [FR 1834749 ] Control applied migration scripts
ALTER TABLE AD_MigrationScript MODIFY DeveloperName NULL
;
...
-- 18/02/2008 11h12min24s BRST
-- [FR 1834749 ] Control applied migration scripts
ALTER TABLE AD_MigrationScript MODIFY ReleaseNo NOT NULL
;
...
-- Feb 18, 2008 11:33:13 AM BRST
-- [FR 1834749 ] Control applied migration scripts
INSERT INTO ad_migrationscript (ad_migrationscript_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, NAME, description, projectname, releaseno, developername, reference, url, filename, status)
VALUES (?, 0, 0, 'Y', '2008-01-01 01:00:00.0', 0, '2000-01-01 02:00:00.0', 0, 'Test2', 'This is a test script2', 'Migration Scripts Automator', 'Release 3.3.0', 'fer_luck', '[FR 1234562]', 'http://www.faire.com.br', '001-tst.sql', 'IP')

;

-- Feb 18, 2008 11:34:00 AM BRST
-- [FR 1834749 ] Control applied migration scripts
INSERT INTO ad_migrationscript (ad_migrationscript_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, NAME, description, projectname, releaseno, developername, reference, url, filename, status)
VALUES (?, 0, 0, 'Y', '2008-01-01 01:00:00.0', 0, '2000-01-01 02:00:00.0', 0, 'Test2', 'This is a test script2', 'Migration Scripts Automator', '340', 'fer_luck', '[FR 1234562]', 'http://www.faire.com.br', '001-tst.sql', 'IP')

;

-- Feb 18, 2008 11:34:00 AM BRST
-- [FR 1834749 ] Control applied migration scripts
update AD_MigrationScript set script = ? where AD_MigrationScript_ID = ?
;
