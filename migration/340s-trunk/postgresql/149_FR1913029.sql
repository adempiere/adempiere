...
-- FR [ 1913092 ] Add the Payment Rule to Commissioning
INSERT INTO AD_Field (IsEncrypted,SortNo,AD_Org_ID,UpdatedBy,IsDisplayed,IsCentrallyMaintained,IsActive,Created,AD_Client_ID,AD_Field_ID,Description,DisplayLength,AD_Column_ID,IsFieldOnly,CreatedBy,Help,Updated,Name,AD_Tab_ID,IsSameLine,IsHeading,SeqNo,IsReadOnly,AD_FieldGroup_ID,EntityType) VALUES ('N',0,0,100,'Y','Y','Y',TO_DATE('2008-03-13 08:19:17','YYYY-MM-DD HH24:MI:SS'),0,54717,'How you pay the invoice',20,54679,'N',100,'The Payment Rule indicates the method of invoice payment.',TO_DATE'2008-03-13 08:19:17','YYYY-MM-DD HH24:MI:SS'),'Payment Rule',356,'N','N',200,'N',104,'D')
/
