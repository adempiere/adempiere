...
-- Fix Payroll bug
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53675,0,'CreateDO',TO_DATE('2008-07-29 11:00:37','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','Create Distribution Order','Creat
e Distribution Order',TO_DATE('2008-07-29 11:00:37','YYYY-MM-DD HH24:MI:SS'),0)
;
