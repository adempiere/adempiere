...
-- Distribution Run Orders
UPDATE AD_Val_Rule SET Code='C_DocType.DocBaseType IN (''SOO'', ''POO'',''DOO'')',Updated=TO_DATE('2008-07-28 20:59:40','YYYY-MM-D
D HH24:MI:SS'),UpdatedBy=0 WHERE AD_Val_Rule_ID=172
;
