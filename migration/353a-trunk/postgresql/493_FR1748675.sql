...
-- Apr 7, 2009 12:03:06 PM MYT
-- FR [2723091] Sponsored Development: Promotions
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,57044,1171,0,10,53177,'Greeting',TO_TIMESTAMP('2009-04-07 12:03:05','YYYY-MM-DD HH24:MI:SS'),100,'For letters, e.g. "Dear {0}" or "Dear Mr. {0}" - At runtime, "{0}" is replaced by the name','D',60,'The Greeting indicates what will print on letters sent to a Business Partner.','Y','N','N','N','N','N','N','N','N','Y','Y','Greeting',0,TO_TIMESTAMP('2009-04-07 12:03:05','YYYY-MM-DD HH24:MI:SS'),100,1)
;

-- Apr 7, 2009 12:03:06 PM MYT
-- FR [2723091] Sponsored Development: Promotions
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Column t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Column_ID=57044 AND EXISTS (SELECT * FROM AD_Column_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Column_ID!=t.AD_Column_ID)
;
